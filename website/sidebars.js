const sidebarSettings = {
  docs: [
    ...
    },
    {
      ...
      link: {
        ...
        description: 'Frequently asked questions about using dbt.',
        slug: 'docs/faqs',
      },
      items: [
        {
  ...
  guides: [
    ...
    },
    {
      ...
      items: [
        "guides/migration/upgrading-to-v1.1",
        "guides/migration/upgrading-to-v1.0",
        "guides/migration/upgrading-to-v0.21",
        "guides/migration/upgrading-to-v0.20",
        {
          type: "category",
          ...
          items: [
            "guides/migration/upgrading-to-0-19-0",
            "guides/migration/upgrading-to-0-18-0",
            "guides/migration/upgrading-to-0-17-0",
            "guides/migration/upgrading-to-0-16-0",
            "guides/migration/upgrading-to-0-15-0",
            "guides/migration/upgrading-to-0-14-1",
            "guides/migration/upgrading-to-0-14-0",
            "guides/migration/upgrading-to-0-13-0",
            "guides/migration/upgrading-to-0-12-0",
            "guides/migration/upgrading-to-0-11-0",
          ],
        },
      ],
    },
