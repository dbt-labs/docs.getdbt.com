module.exports = {
  ...
  "dbt Cloud": [
    ...
    {
      type: "category",
      label: "Setting up dbt Cloud",
      items: [
        "docs/dbt-cloud/setting-up-dbt-cloud/create-a-new-project",
        ...
        "docs/dbt-cloud/setting-up-dbt-cloud/configure-a-repository/gitlab-repository",
        "docs/dbt-cloud/setting-up-dbt-cloud/configure-a-repository/configuring-pr-templates",
        "docs/dbt-cloud/setting-up-dbt-cloud/create-an-environment",
        "docs/dbt-cloud/setting-up-dbt-cloud/create-an-environment/development-environment",
        "docs/dbt-cloud/setting-up-dbt-cloud/create-an-environment/deployment-environment",
      ],
    },
    {
      type: "category",
