  ...
  "docs-next": [
    {
      type: "category",
      label: "Introduction",
      items: ["docs-next/introduction", "docs-next/available-adapters", "docs-next/core-versions"],
    },
    {
      type: "category",
      label: "Building a dbt Project",
      collapsed: true,
      items: [
        "docs-next/building-a-dbt-project/projects",
        {
          type: "category",
          label: "Models",
          items: [
            "docs-next/building-a-dbt-project/building-models",
            "docs-next/building-a-dbt-project/building-models/materializations",
            "docs-next/building-a-dbt-project/building-models/configuring-incremental-models",
            "docs-next/building-a-dbt-project/building-models/using-custom-aliases",
            "docs-next/building-a-dbt-project/building-models/using-custom-schemas",
            "docs-next/building-a-dbt-project/building-models/using-custom-databases",
            "docs-next/building-a-dbt-project/building-models/using-variables",
          ],
        },
        "docs-next/building-a-dbt-project/tests",
        "docs-next/building-a-dbt-project/documentation",
        "docs-next/building-a-dbt-project/using-sources",
        "docs-next/building-a-dbt-project/seeds",
        "docs-next/building-a-dbt-project/snapshots",
        "docs-next/building-a-dbt-project/exposures",
        "docs-next/building-a-dbt-project/jinja-macros",
        "docs-next/building-a-dbt-project/hooks-operations",
        //"docs-next/building-a-dbt-project/dont-nest-your-curlies",
        //"docs-next/building-a-dbt-project/archival",
        "docs-next/building-a-dbt-project/package-management",
        "docs-next/building-a-dbt-project/analyses",
        "docs-next/building-a-dbt-project/metrics",
      ],
    },
    {
      type: "category",
      ...
      collapsed: true,
      items: [
        "docs-next/running-a-dbt-project/using-the-dbt-ide",
        "docs-next/running-a-dbt-project/using-the-cli",
        "docs-next/running-a-dbt-project/dbt-api",
        "docs-next/running-a-dbt-project/running-dbt-in-production",
      ],
    },
    {
      type: "category",
      label: "Contributing",
      items: [
        "docs-next/contributing/oss-expectations",
        "docs-next/contributing/contributor-license-agreements",
        "docs-next/contributing/building-a-new-adapter",
        "docs-next/contributing/testing-a-new-adapter",
        "docs-next/contributing/documenting-a-new-adapter",
        "docs-next/contributing/slack-rules-of-the-road",
        "docs-next/contributing/long-lived-discussions-guidelines",
      ],
    },
    {
      type: "category",
      label: "About",
      items: ["docs-next/about/license", "docs-next/about/viewpoint"],
    },
    {
      type: "category",
      label: "Frequently asked questions",
      link: {
        type: 'generated-index', title: 'Frequently asked questions',
        description: 'Our Frequently Asked Questions (FAQs) section is a space where you can find an answer to some questions we get asked a lot (but that we’re happy to answer!). If you have a question or are still stuck on something, just reach out to us by emailing support@getdbt.com or clicking on the chat widget, and we’ll do our best to help out.', slug: '/docs-next/faqs',
      },
      items: [
        {
          type: 'autogenerated',
