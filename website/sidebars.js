const sidebarSettings = {
  ...
  sqlFunctions: [
    "sql-functions-glossary/introduction",      
    {
      type: "category",
      label: "Chapter 1",
      link: {
        ...
        title: "Chapter 1",
        description: "Test",
        slug: "sql-functions-glossary/sql-chapter-1"
      },
      items: [
        {
          type: "autogenerated",
          dirName: "sql-functions-glossary/sql-chapter-1",
        },
      ],
    },
    {
      ...
      //   title: "Chapter 2",
      //   description: "Test",
      //   slug: "sql-functions-glossary/sql-chapter-2"
      // },
      items: [
        {
          type: "autogenerated",
          dirName: "sql-functions-glossary/sql-chapter-2",
        },
      ],
    },
    {
      type: "doc",
      label: "Chapter 3",
      id: "sql-functions-glossary/chapter-3"
    },
    {
      type: "category",
      label: "Chapter 4",
      link: {
        ...
        title: "Chapter 4",
        description: "Test",
        slug: "sql-functions-glossary/sql-chapter-4"
      },
      items: [
        {
          type: "autogenerated",
          dirName: "sql-functions-glossary/sql-chapter-4",
        },
      ],
    },
  ],
