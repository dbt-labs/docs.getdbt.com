  ...
  reference: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: "category",
          label: "Amazon Athena configurations",
          link: { type: "doc", id: "reference/resource-configs/athena-configs" },
          items: [
            "reference/resource-configs/athena-configs/models",
            "reference/resource-configs/athena-configs/snapshots",
            "reference/resource-configs/athena-configs/aws-lake-formation-integration",
            "reference/resource-configs/athena-configs/python-models",
            "reference/resource-configs/athena-configs/contracts",
          ],
        },
        {
          type: "category",
          label: "Cloudera Impala configurations",
          link: { type: "doc", id: "reference/resource-configs/impala-configs" },
          items: [
            "reference/resource-configs/impala-configs/configuring-tables",
            "reference/resource-configs/impala-configs/incremental-models",
            "reference/resource-configs/impala-configs/example-using-partition_by-config-option",
          ],
        },
        {
          type: "category",
          label: "Apache Spark configurations",
          link: { type: "doc", id: "reference/resource-configs/spark-configs" },
          items: [
            "reference/resource-configs/spark-configs/configuring-tables",
            "reference/resource-configs/spark-configs/incremental-models",
            "reference/resource-configs/spark-configs/persisting-model-descriptions",
            "reference/resource-configs/spark-configs/always-schema-never-database",
            "reference/resource-configs/spark-configs/default-file-format-configurations",
            "reference/resource-configs/spark-configs/retry-handling-for-pyhive-connections",
          ],
        },
        {
          type: "category",
          label: "BigQuery configurations",
          link: { type: "doc", id: "reference/resource-configs/bigquery-configs" },
          items: [
            "reference/resource-configs/bigquery-configs/use-project-and-dataset-in-configurations",
            "reference/resource-configs/bigquery-configs/using-table-partitioning-and-clustering",
            "reference/resource-configs/bigquery-configs/using-reservations",
            "reference/resource-configs/bigquery-configs/managing-kms-encryption",
            "reference/resource-configs/bigquery-configs/labels-and-tags",
            "reference/resource-configs/bigquery-configs/merge-behavior-incremental-models",
            "reference/resource-configs/bigquery-configs/controlling-table-expiration",
            "reference/resource-configs/bigquery-configs/authorized-views",
            "reference/resource-configs/bigquery-configs/materialized-views",
            "reference/resource-configs/bigquery-configs/python-model-configuration",
            "reference/resource-configs/bigquery-configs/unit-test-limitations",
          ],
        },
        "reference/resource-configs/bigquery-function-support",
        {
          type: "category",
          label: "ClickHouse configurations",
          link: { type: "doc", id: "reference/resource-configs/clickhouse-configs" },
          items: [
            "reference/resource-configs/clickhouse-configs/clickhouse-configurations",
            "reference/resource-configs/clickhouse-configs/snapshot",
            "reference/resource-configs/clickhouse-configs/learn-more",
          ],
        },
        {
          type: "category",
          label: "Confluent Cloud configurations",
          link: { type: "doc", id: "reference/resource-configs/confluent-configs" },
          items: [
            "reference/resource-configs/confluent-configs/materializations",
            "reference/resource-configs/confluent-configs/materialization-specific-configurations",
            "reference/resource-configs/confluent-configs/stateful-behavior-and---full-refresh",
            "reference/resource-configs/confluent-configs/known-limitations",
          ],
        },
        {
          type: "category",
          label: "Databricks configurations",
          link: { type: "doc", id: "reference/resource-configs/databricks-configs" },
          items: [
            "reference/resource-configs/databricks-configs/configuring-tables",
            "reference/resource-configs/databricks-configs/configuring-columns",
            "reference/resource-configs/databricks-configs/setting-row-filters",
            "reference/resource-configs/databricks-configs/incremental-models",
            "reference/resource-configs/databricks-configs/python-model-configuration",
            "reference/resource-configs/databricks-configs/selecting-compute-per-model",
            "reference/resource-configs/databricks-configs/persisting-model-descriptions",
            "reference/resource-configs/databricks-configs/query-tags",
            "reference/resource-configs/databricks-configs/default-file-format-configurations",
            "reference/resource-configs/databricks-configs/materialized-views-and-streaming-tables",
            "reference/resource-configs/databricks-configs/metric-views",
            "reference/resource-configs/databricks-configs/setting-table-properties",
          ],
        },
        {
          type: "category",
          label: "DeltaStream configurations",
          link: { type: "doc", id: "reference/resource-configs/deltastream-configs" },
          items: [
            "reference/resource-configs/deltastream-configs/supported-materializations",
            "reference/resource-configs/deltastream-configs/sql-model-configurations",
            "reference/resource-configs/deltastream-configs/yaml-only-resource-configurations",
            "reference/resource-configs/deltastream-configs/store-configurations",
            "reference/resource-configs/deltastream-configs/entity-configuration",
            "reference/resource-configs/deltastream-configs/compute-pool-configuration",
            "reference/resource-configs/deltastream-configs/referencing-resources",
            "reference/resource-configs/deltastream-configs/seeds",
            "reference/resource-configs/deltastream-configs/function-and-source-materializations",
            "reference/resource-configs/deltastream-configs/query-management-macros",
            "reference/resource-configs/deltastream-configs/application-macro",
            "reference/resource-configs/deltastream-configs/troubleshooting",
          ],
        },
        "reference/resource-configs/doris-configs",
        {
          type: "category",
          label: "DuckDB configurations",
          link: { type: "doc", id: "reference/resource-configs/duckdb-configs" },
          items: [
            "reference/resource-configs/duckdb-configs/secrets-manager",
            "reference/resource-configs/duckdb-configs/cloud-storage-with-fsspec",
            "reference/resource-configs/duckdb-configs/arbitrary-attach-options",
            "reference/resource-configs/duckdb-configs/ducklake",
            "reference/resource-configs/duckdb-configs/plugins",
            "reference/resource-configs/duckdb-configs/python-models",
            "reference/resource-configs/duckdb-configs/external-files",
            "reference/resource-configs/duckdb-configs/table_function-materialization",
            "reference/resource-configs/duckdb-configs/incremental-strategies",
            "reference/resource-configs/duckdb-configs/interactive-shell",
            "reference/resource-configs/duckdb-configs/more-information",
          ],
        },
        {
          type: "category",
          label: "Exasol configurations",
          link: { type: "doc", id: "reference/resource-configs/exasol-configs" },
          items: [
            "reference/resource-configs/exasol-configs/incremental-materialization-strategies",
            "reference/resource-configs/exasol-configs/performance-optimizations",
            "reference/resource-configs/exasol-configs/model-contracts",
            "reference/resource-configs/exasol-configs/timestamp-format",
            "reference/resource-configs/exasol-configs/materialized-views",
            "reference/resource-configs/exasol-configs/clone-operations",
            "reference/resource-configs/exasol-configs/unit-test-limitations",
            "reference/resource-configs/exasol-configs/connection-configuration",
          ],
        },
        {
          type: "category",
          label: "Microsoft Fabric Data Warehouse configurations",
          link: { type: "doc", id: "reference/resource-configs/fabric-configs" },
          items: [
            "reference/resource-configs/fabric-configs/materializations",
            "reference/resource-configs/fabric-configs/table-clone",
            "reference/resource-configs/fabric-configs/seeds",
            "reference/resource-configs/fabric-configs/views",
            "reference/resource-configs/fabric-configs/snapshots",
            "reference/resource-configs/fabric-configs/indexes",
            "reference/resource-configs/fabric-configs/grants-with-auto-provisioning",
            "reference/resource-configs/fabric-configs/incremental-models",
            "reference/resource-configs/fabric-configs/permissions",
            "reference/resource-configs/fabric-configs/cross-warehouse-references",
            "reference/resource-configs/fabric-configs/warehouse-snapshots",
          ],
        },
        {
          type: "category",
          label: "Microsoft Fabric Spark configurations",
          link: { type: "doc", id: "reference/resource-configs/fabricspark-configs" },
          items: [
            "reference/resource-configs/fabricspark-configs/configuring-tables",
            "reference/resource-configs/fabricspark-configs/incremental-models",
            "reference/resource-configs/fabricspark-configs/persisting-model-descriptions",
            "reference/resource-configs/fabricspark-configs/always-schema-never-database",
            "reference/resource-configs/fabricspark-configs/default-file-format-configurations",
          ],
        },
        {
          type: "category",
          label: "Firebolt configurations",
          link: { type: "doc", id: "reference/resource-configs/firebolt-configs" },
          items: [
            "reference/resource-configs/firebolt-configs/setting-quote_columns",
            "reference/resource-configs/firebolt-configs/model-configuration-for-fact-tables",
            "reference/resource-configs/firebolt-configs/model-configuration-for-dimension-tables",
            "reference/resource-configs/firebolt-configs/how-aggregating-indexes-are-named",
            "reference/resource-configs/firebolt-configs/managing-ingestion-via-external-tables",
            "reference/resource-configs/firebolt-configs/incremental-models",
            "reference/resource-configs/firebolt-configs/seeds-behavior",
            "reference/resource-configs/firebolt-configs/practice",
          ],
        },
        "reference/resource-configs/greenplum-configs",
        {
          type: "category",
          label: "Cloudera Hive configurations",
          link: { type: "doc", id: "reference/resource-configs/hive-configs" },
          items: [
            "reference/resource-configs/hive-configs/configuring-tables",
            "reference/resource-configs/hive-configs/incremental-models",
            "reference/resource-configs/hive-configs/example-using-partition_by-config-option",
          ],
        },
        "reference/resource-configs/infer-configs",
        {
          type: "category",
          label: "IBM Netezza configurations",
          link: { type: "doc", id: "reference/resource-configs/ibm-netezza-config" },
          items: [
            "reference/resource-configs/ibm-netezza-config/instance-requirements",
            "reference/resource-configs/ibm-netezza-config/seeds-and-prepared-statements",
          ],
        },
        "reference/resource-configs/materialize-configs",
        {
          type: "category",
          label: "Microsoft SQL Server configurations",
          link: { type: "doc", id: "reference/resource-configs/mssql-configs" },
          items: [
            "reference/resource-configs/mssql-configs/materializations",
            "reference/resource-configs/mssql-configs/seeds",
            "reference/resource-configs/mssql-configs/snapshots",
            "reference/resource-configs/mssql-configs/indices",
            "reference/resource-configs/mssql-configs/grants-with-auto-provisioning",
            "reference/resource-configs/mssql-configs/permissions",
            "reference/resource-configs/mssql-configs/cross-database-macros",
            "reference/resource-configs/mssql-configs/dbt-utils",
          ],
        },
        {
          type: "category",
          label: "MindsDB configurations",
          link: { type: "doc", id: "reference/resource-configs/mindsdb-configs" },
          items: [
            "reference/resource-configs/mindsdb-configs/authentication",
            "reference/resource-configs/mindsdb-configs/usage",
          ],
        },
        {
          type: "category",
          label: "Oracle configurations",
          link: { type: "doc", id: "reference/resource-configs/oracle-configs" },
          items: [
            "reference/resource-configs/oracle-configs/use-parallel-hint",
            "reference/resource-configs/oracle-configs/use-table_compression_clause",
            "reference/resource-configs/oracle-configs/partitioning",
            "reference/resource-configs/oracle-configs/session-info-in-vsession",
          ],
        },
        {
          type: "category",
          label: "Postgres configurations",
          link: { type: "doc", id: "reference/resource-configs/postgres-configs" },
          items: [
            "reference/resource-configs/postgres-configs/incremental-materialization-strategies",
            "reference/resource-configs/postgres-configs/performance-optimizations",
            "reference/resource-configs/postgres-configs/materialized-views",
          ],
        },
        {
          type: "category",
          label: "Redshift configurations",
          link: { type: "doc", id: "reference/resource-configs/redshift-configs" },
          items: [
            "reference/resource-configs/redshift-configs/incremental-materialization-strategies",
            "reference/resource-configs/redshift-configs/performance-optimizations",
            "reference/resource-configs/redshift-configs/datasharing",
            "reference/resource-configs/redshift-configs/late-binding-views",
            "reference/resource-configs/redshift-configs/materialized-views",
            "reference/resource-configs/redshift-configs/unit-test-limitations",
          ],
        },
        {
          type: "category",
          label: "SingleStore configurations",
          link: { type: "doc", id: "reference/resource-configs/singlestore-configs" },
          items: [
            "reference/resource-configs/singlestore-configs/incremental-materialization-strategies",
            "reference/resource-configs/singlestore-configs/performance-optimizations",
            "reference/resource-configs/singlestore-configs/model-contracts",
          ],
        },
        {
          type: "category",
          label: "Snowflake configurations",
          link: { type: "doc", id: "reference/resource-configs/snowflake-configs" },
          items: [
            "reference/resource-configs/snowflake-configs/iceberg-table-format",
            "reference/resource-configs/snowflake-configs/dynamic-tables",
            "reference/resource-configs/snowflake-configs/semantic-views",
            "reference/resource-configs/snowflake-configs/temporary-tables",
            "reference/resource-configs/snowflake-configs/transient-tables",
            "reference/resource-configs/snowflake-configs/query-tags",
            "reference/resource-configs/snowflake-configs/merge-behavior-incremental-models",
            "reference/resource-configs/snowflake-configs/configuring-table-clustering",
            "reference/resource-configs/snowflake-configs/python-model-configuration",
            "reference/resource-configs/snowflake-configs/configuring-virtual-warehouses",
            "reference/resource-configs/snowflake-configs/copying-grants",
            "reference/resource-configs/snowflake-configs/setting-row-access-policies",
            "reference/resource-configs/snowflake-configs/configuring-table-tags",
            "reference/resource-configs/snowflake-configs/secure-views",
            "reference/resource-configs/snowflake-configs/source-freshness-known-limitation",
            "reference/resource-configs/snowflake-configs/pagination-for-object-results",
          ],
        },
        "reference/resource-configs/snowflake-function-support",
        {
          type: "category",
          label: "Starburst/Trino configurations",
          link: { type: "doc", id: "reference/resource-configs/trino-configs" },
          items: [
            "reference/resource-configs/trino-configs/cluster-requirements",
            "reference/resource-configs/trino-configs/session-properties",
            "reference/resource-configs/trino-configs/connector-properties",
            "reference/resource-configs/trino-configs/file-format-configuration",
            "reference/resource-configs/trino-configs/seeds-and-prepared-statements",
            "reference/resource-configs/trino-configs/materializations",
            "reference/resource-configs/trino-configs/snapshots",
            "reference/resource-configs/trino-configs/grants",
            "reference/resource-configs/trino-configs/model-contracts",
          ],
        },
        {
          type: "category",
          label: "Starrocks configurations",
          link: { type: "doc", id: "reference/resource-configs/starrocks-configs" },
          items: [
            "reference/resource-configs/starrocks-configs/model-configuration",
            "reference/resource-configs/starrocks-configs/read-from-catalog",
          ],
        },
        {
          type: "category",
          label: "Teradata configurations",
          link: { type: "doc", id: "reference/resource-configs/teradata-configs" },
          items: [
            "reference/resource-configs/teradata-configs/general",
            "reference/resource-configs/teradata-configs/models",
            "reference/resource-configs/teradata-configs/seeds",
            "reference/resource-configs/teradata-configs/snapshots",
            "reference/resource-configs/teradata-configs/query-band",
            "reference/resource-configs/teradata-configs/unit-testing",
            "reference/resource-configs/teradata-configs/valid_history-incremental-materialization-strategy",
            "reference/resource-configs/teradata-configs/common-teradata-specific-tasks",
            "reference/resource-configs/teradata-configs/the-external-tables-package",
          ],
        },
        {
          type: "category",
          label: "Upsolver configurations",
          link: { type: "doc", id: "reference/resource-configs/upsolver-configs" },
          items: [
            "reference/resource-configs/upsolver-configs/supported-upsolver-sqlake-functionality",
            "reference/resource-configs/upsolver-configs/configs-materialization",
            "reference/resource-configs/upsolver-configs/sql-connection",
            "reference/resource-configs/upsolver-configs/sql-copy-job",
            "reference/resource-configs/upsolver-configs/sql-insert-job",
            "reference/resource-configs/upsolver-configs/sql-merge-job",
            "reference/resource-configs/upsolver-configs/sql-materialized-views",
            "reference/resource-configs/upsolver-configs/expectationsconstraints",
            "reference/resource-configs/upsolver-configs/projects-examples",
            "reference/resource-configs/upsolver-configs/connection-options",
            "reference/resource-configs/upsolver-configs/target-options",
            "reference/resource-configs/upsolver-configs/transformation-options",
            "reference/resource-configs/upsolver-configs/copy-options",
          ],
        },
        {
          type: "category",
          label: "Vertica configurations",
          link: { type: "doc", id: "reference/resource-configs/vertica-configs" },
          items: [
            "reference/resource-configs/vertica-configs/configuration-of-incremental-models",
            "reference/resource-configs/vertica-configs/optimization-options-for-table-materialization",
          ],
        },
        {
          type: "category",
          label: "IBM watsonx.data Presto configurations",
          link: { type: "doc", id: "reference/resource-configs/watsonx-presto-config" },
          items: [
            "reference/resource-configs/watsonx-presto-config/instance-requirements",
            "reference/resource-configs/watsonx-presto-config/session-properties",
            "reference/resource-configs/watsonx-presto-config/connector-properties",
            "reference/resource-configs/watsonx-presto-config/file-format-configuration",
            "reference/resource-configs/watsonx-presto-config/seeds",
            "reference/resource-configs/watsonx-presto-config/materializations",
            "reference/resource-configs/watsonx-presto-config/unsupported-features",
          ],
        },
        {
          type: "category",
          label: "IBM watsonx.data Spark configurations",
          link: { type: "doc", id: "reference/resource-configs/watsonx-spark-config" },
          items: [
            "reference/resource-configs/watsonx-spark-config/instance-requirements",
            "reference/resource-configs/watsonx-spark-config/session-properties",
            "reference/resource-configs/watsonx-spark-config/connector-properties",
            "reference/resource-configs/watsonx-spark-config/seeds-and-prepared-statements",
            "reference/resource-configs/watsonx-spark-config/materializations",
            "reference/resource-configs/watsonx-spark-config/unsupported-features",
          ],
        },
        {
          type: "category",
          label: "Yellowbrick configurations",
          link: { type: "doc", id: "reference/resource-configs/yellowbrick-configs" },
          items: [
            "reference/resource-configs/yellowbrick-configs/incremental-materialization-strategies",
            "reference/resource-configs/yellowbrick-configs/performance-optimizations",
            "reference/resource-configs/yellowbrick-configs/cross-database-materializations",
            "reference/resource-configs/yellowbrick-configs/limitations",
          ],
        },
      ]
    },
