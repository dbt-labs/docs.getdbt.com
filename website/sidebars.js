const sidebarSettings = {
  ...
  apis: [
    "docs/dbt-platform-apis/overview",
    {
      type: "category",
      label: "API Access",
      link: { type: "doc", id: "docs/dbt-platform-apis/authentication" },
      items: [
        "docs/dbt-platform-apis/authentication",
        "docs/dbt-platform-apis/user-tokens",
        "docs/dbt-platform-apis/service-tokens",
      ],
    },
    {
      type: "category",
      label: "Administrative API",
      link: { type: "doc", id: "docs/dbt-platform-apis/admin-cloud-api" },
      items: [
        "docs/dbt-platform-apis/admin-cloud-api",
        {
          type: "link",
          label: "API v2",
    ...
    },
    {
      type: "category",
      label: "Discovery API",
      link: { type: "doc", id: "docs/dbt-platform-apis/discovery-api" },
      items: [
        "docs/dbt-platform-apis/discovery-api",
        "docs/dbt-platform-apis/discovery-use-cases-and-examples",
        "docs/dbt-platform-apis/project-state",
        "docs/dbt-platform-apis/discovery-querying",
        {
          type: "category",
          label: "Schema",
          link: {
            type: "doc",
            id: "docs/dbt-platform-apis/discovery-schema-about",
          },
          items: [
            "docs/dbt-platform-apis/discovery-schema-about",
            {
              type: "category",
              label: "Environment (recommended)",
              link: {
                type: "doc",
                id: "docs/dbt-platform-apis/discovery-schema-environment",
              },
              items: [
                "docs/dbt-platform-apis/discovery-schema-environment",
                {
                  type: "category",
                  label: "Applied",
                  link: {
                    type: "doc",
                    id: "docs/dbt-platform-apis/discovery-schema-environment-applied",
                  },
                  items: [
                    "docs/dbt-platform-apis/discovery-schema-environment-applied",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-tests",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-sources",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-snapshots",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-seeds",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-resources",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-models",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-exposures",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-exposure-tile",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-tags",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-packages",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-owners",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-modelHistoricalRuns",
                    "docs/dbt-platform-apis/discovery-schema-environment-applied-lineage",
                  ],
                },
                "docs/dbt-platform-apis/discovery-schema-environment-definition",
              ],
            },
            ...
            // },
            {
              ...
              link: {
                type: "doc",
                id: "docs/dbt-platform-apis/discovery-schema-job",
              },
              items: [
                "docs/dbt-platform-apis/discovery-schema-job",
                "docs/dbt-platform-apis/discovery-schema-job-model",
                "docs/dbt-platform-apis/discovery-schema-job-models",
                "docs/dbt-platform-apis/discovery-schema-job-source",
                "docs/dbt-platform-apis/discovery-schema-job-sources",
                "docs/dbt-platform-apis/discovery-schema-job-seed",
                "docs/dbt-platform-apis/discovery-schema-job-seeds",
                // "docs/dbt-platform-apis/discovery-schema-job-snapshot",
                "docs/dbt-platform-apis/discovery-schema-job-snapshots",
                "docs/dbt-platform-apis/discovery-schema-job-test",
                "docs/dbt-platform-apis/discovery-schema-job-tests",
                "docs/dbt-platform-apis/discovery-schema-job-exposure",
                "docs/dbt-platform-apis/discovery-schema-job-exposures",
                // "docs/dbt-platform-apis/discovery-schema-job-macro",
                // "docs/dbt-platform-apis/discovery-schema-job-macros",
              ],
            },
          ],
        },
    ...
    },
    {
      ...
      link: { type: "doc", id: "docs/dbt-platform-apis/sl-api-overview" },
      items: [
        "docs/dbt-platform-apis/sl-api-overview",
        "docs/dbt-platform-apis/sl-graphql",
        "docs/dbt-platform-apis/sl-jdbc",
        "docs/dbt-platform-apis/sl-python",
      ],
    },
  ],
  reference: [
