...
- [**<Constant name="platform_cli" /> users**](#dbt-cli-users) &mdash; The [<Constant name="platform_cli" />](/docs/platform/cloud-cli-installation) enables you to run [MetricFlow commands](/docs/build/metricflow-commands#metricflow-commands) to query and preview metrics directly in your command line interface.
