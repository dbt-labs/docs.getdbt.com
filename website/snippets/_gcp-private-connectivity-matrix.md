...
The following charts outline private connectivity options for GCP deployments of <Constant name="dbt" /> ([multi-tenant](/docs/platform/about-cloud/tenancy)).
...
_Tenancy:_ MT (multi-tenant) — [learn more about tenancy](/docs/platform/about-cloud/tenancy).
