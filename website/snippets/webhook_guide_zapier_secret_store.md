This guide assumes the secrets are stored under the key names `DBT_CLOUD_SERVICE_TOKEN` and `DBT_WEBHOOK_KEY`. If you choose a different name, make sure you update all references to it in the sample code.
