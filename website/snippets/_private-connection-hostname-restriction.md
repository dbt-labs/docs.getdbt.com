...
- Using [Environment variables](/docs/build/environment-variables) when configuring private connection endpoints isn't supported in <Constant name="dbt" />. Instead, use [Extended Attributes](/docs/dbt-platform-environments#extended-attributes) to dynamically change these values in your <Constant name="dbt" /> environment.
