...
- If you're using Tableau Server, you need to [allowlist <Constant name="dbt" />'s IP addresses](/docs/platform/about-cloud/access-regions-ip-addresses) for your <Constant name="dbt" /> region.
