...
If necessary, you can also install the <Constant name="fusion_engine" /> directly using these instructions: [Install the Fusion CLI](/docs/local/install-dbt?version=2)
</Expandable>
