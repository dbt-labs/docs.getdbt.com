...
The warning persists across restarts until you update. If you work in an air-gapped environment, refer to [known-bad releases](/docs/fusion/fusion-version-compatibility#known-bad-releases) for how to distribute the manifest locally.
