...
- Build <Term id="idempotent">idempotent</Term> transformations that are safe to rerun and produce consistent results. Learn more in [Idempotence in dbt](/best-practices/idempotence).
