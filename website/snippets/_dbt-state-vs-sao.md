...
If you were using state-aware orchestration prior to June 1, 2026, you can continue using it. As an existing customer, your dbt State trial will be extended until the billing period begins on September 1, 2026. If you don't see the extension, contact your account team. For details on billing after the trial ends, refer to [dbt State usage and pricing](/docs/platform/billing#dbt-state-usage). 
