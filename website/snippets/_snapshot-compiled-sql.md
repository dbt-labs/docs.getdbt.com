...
Starting dbt v1.12, you can inspect the SQL generated for this snapshot by running [`dbt compile`](/reference/commands/compile) or `dbt compile --select orders_snapshot`. 
