...
4. Update the fields you want to change. For example, you can edit the environment name, dbt version (for eligible account tiers and supported adapters, **<Constant name="fusion" /> Stable** is the default for new deployment environments).
