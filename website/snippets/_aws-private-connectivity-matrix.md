...
The following charts outline private connectivity options for AWS deployments of <Constant name="dbt" /> ([multi-tenant and single-tenant](/docs/platform/about-cloud/tenancy)).
