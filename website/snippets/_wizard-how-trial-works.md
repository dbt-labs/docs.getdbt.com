...
| Enterprise, including [legacy Enterprise](/docs/platform/billing/plans-and-billing#legacy-plans) | $100/month in usage credits per account | Resets each billing month | Usage continues uninterrupted. [Contact your account team](https://www.getdbt.com/contact) to add committed spend |
...
- Depleting your Enterprise or Enterprise+ monthly credits doesn't pause {props.product}. Usage keeps going, and you'll be prompted to connect with your account rep about adding a committed spend amount. Any optional monthly spend limit you've set still pauses usage once reached.
