...
OAuth clients such as [<Constant name="platform_cli"/>](/docs/platform/cloud-cli-installation), the [dbt VS Code extension](/docs/about-dbt-extension?version=2.0), and [dbt MCP](/docs/dbt-ai/about-mcp) have not yet been updated to use `login.dbt.com` and continue to authenticate through their account [**Access URL**](/docs/platform/about-platform/access-regions-ip-addresses).
