...
dbt Labs is committed to zero breaking changes for code in dbt projects, with ongoing releases to <Constant name="dbt" />. We also recommend these best practices:
