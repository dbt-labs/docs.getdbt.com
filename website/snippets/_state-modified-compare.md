You need to build the state directory using dbt v1.9 or higher, or [the <Constant name="cloud" /> "Latest" release track](/docs/dbt-versions/cloud-release-tracks), and you need to set `state_modified_compare_more_unrendered_values` to `true` within your dbt_project.yml.
