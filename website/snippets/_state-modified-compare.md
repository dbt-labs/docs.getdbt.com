You need to build the state directory using dbt v1.9 or higher, or [the <Constant name="dbt" /> **v1 Latest** release track](/docs/dbt-versions/dbt-release-tracks), and you need to set `state_modified_compare_more_unrendered_values` to `true` within your dbt_project.yml.
