...
For customers of <Constant name="dbt" />: dbt Labs strongly recommends migrating environments on older and unsupported versions to [release tracks](/docs/dbt-versions/dbt-release-tracks) or a supported version.
