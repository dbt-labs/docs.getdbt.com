...
You don't need [AI features](/docs/platform/manage-dbt-ai) enabled to use remote MCP. If an admin turns AI features off, [`text_to_sql`](/docs/dbt-ai/mcp-available-tools#tools-that-require-ai-features) is the only toolset hidden and every other tool keeps working.
