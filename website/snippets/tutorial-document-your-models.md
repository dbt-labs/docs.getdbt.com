...
[<Constant name="explorer" />](/docs/explore/explore-projects) provides powerful tools to interact with your dbt projects, including documentation:
...
<Constant name="explorer" /> displays your model's description, column documentation, data tests, and lineage graph. You can also see which columns are missing documentation and track test coverage across your project.
