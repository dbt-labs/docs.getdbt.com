...
<Lightbox src="/img/docs/dbt-cloud/semantic-layer/new-sl-configure.jpg" width="65%" width="60%" title="Semantic Layer section in the Project Details page"/>
...
<Lightbox src="/img/docs/dbt-cloud/semantic-layer/sl-configure-sl.jpg" width="65%" width="45%" title="Enter the credentials you want the Semantic Layer to use specific to your data platform, and select the deployment environment."/>
...
<Lightbox src="/img/docs/dbt-cloud/semantic-layer/sl-configure-example.jpg" width="65%" width="50%" title="After you configure the Semantic Layer, you'll be provided with the connection information to connect to you downstream tools." />
