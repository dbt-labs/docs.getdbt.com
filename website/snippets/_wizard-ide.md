...
For more on how to prepare your project for <Constant name="fusion" /> and what to do when you hit compatibility errors, see the [Fusion readiness checklist](/docs/dbt/fusion-readiness) and the [Upgrade to Fusion guides](/guides/prepare-fusion-upgrade).
