...
1. Verify the bastion server has its network security rules set up to accept connections from the [<Constant name="dbt" /> IP addresses](/docs/platform/about-cloud/access-regions-ip-addresses) on whatever port you configured.
