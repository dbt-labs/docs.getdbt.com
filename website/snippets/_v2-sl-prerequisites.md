...
- Note that SSH tunneling for [Postgres and Redshift](/docs/cloud/connect-data-platform/connect-redshift-postgresql-alloydb) connections, and [PrivateLink](/docs/cloud/secure/about-privatelink) doesn't support the dbt Semantic Layer yet.
