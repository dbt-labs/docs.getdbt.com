...
The following charts outline private connectivity options for Azure deployments of <Constant name="dbt" /> ([multi-tenant and single-tenant](/docs/platform/about-cloud/tenancy)).

**Legend:**
- ✅ = Available
- ❌ = Not currently available

_Tenancy:_ MT (multi-tenant) and ST (single-tenant) — [learn more about tenancy](/docs/platform/about-cloud/tenancy).
