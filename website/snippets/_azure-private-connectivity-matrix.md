...
For services not explicitly listed above, you may still be able to establish private connectivity using the same <Term id="customer-provisioned">customer-provisioned</Term> approach. For detailed instructions, see [Azure Private Link for self-hosted services](/docs/cloud/secure/azure/azure-self-hosted).
