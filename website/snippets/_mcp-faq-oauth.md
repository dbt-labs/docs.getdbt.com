...
If these steps don't resolve the issue, confirm that AI features are enabled on your account. An account admin can enable them in **Account settings** → **Edit** → toggle on **Enable account access to dbt Copilot features**. Refer to [Enable dbt Copilot](/docs/platform/enable-dbt-copilot).
</Expandable>
