...
description: "How to make your Slim CI process more intelligent and, as a result, enable faster continuous integration workflows."
...
2. Next, create a workflow file in your dbt project for your specific git provider.
...
- `schema_override` - Match what dbt Cloud does natively - `dbt_cloud_pr_<job_id>_<pull_request_id>`
- `git_sha` - `$(Build.SourceVersion)`
- `gitlab_merge_request_id` - `$(System.PullRequest.PullRequestId)`
...
The loom video below shows a quick demo of this functionality in action!

https://www.loom.com/share/5f63e40c356145489a741dac87b47595
...
If any of that sounds interesting, or you have other ideas, feel free to reach out to me on Slack - @Doug Guthrie.