...
or just manually copy the files you want into your project's `.<agent>/skills/` directory.
...
So dbt Agent skills and the [dbt MCP server](/blog/introducing-dbt-mcp-server) are _complementary_, but you don't have to use both to get value.
