...
This new spec is **live on the Fusion engine today.** If you’ve [migrated](/guides/upgrade-to-v2?step=1) onto the engine, and are curious about getting started with the dbt Semantic Layer, [check out our docs](/docs/build/latest-metrics-spec) and get started defining your metrics! This new spec will also be released to dbt Core in version 1.12, coming in the near future. dbt platform users on the dbt Core engine will be able to migrate to the new spec as soon as they upgrade to the Latest dbt version!
