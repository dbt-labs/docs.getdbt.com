...
- [Discovery API (formerly referred to as Metadata API)](https://docs.getdbt.com/docs/dbt-apis/discovery-api)
...
- [Administrative (Admin) API](https://docs.getdbt.com/docs/dbt-apis/admin-cloud-api)
...
- [Semantic Layers/Metrics](https://docs.getdbt.com/docs/dbt-apis/sl-api-overview)
...
- dbt lineage
    ...
    - **Example** &mdash; In your tool, you want to pull in the dbt DAG into your lineage diagram. For details on what you could pull and how to do this, refer to [Use cases and examples for the Discovery API](https://docs.getdbt.com/docs/dbt-apis/discovery-use-cases-and-examples).
