...
This is a place to leave post-merge instructions. Maybe you updated your existing [incremental model](/docs/building-a-dbt-project/building-models/configuring-incremental-models) with an additional column and need to run a [full refresh](/docs/building-a-dbt-project/building-models/configuring-incremental-models#how-do-i-rebuild-an-incremental-model). 
...
**I have [materialized my models](/docs/building-a-dbt-project/building-models/materializations) appropriately.**
