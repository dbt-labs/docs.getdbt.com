...
> Refer to the [BigFrames guide](https://cloud.google.com/bigquery/docs/bigquery-dataframes-introduction) or [dbt guides](/guides/dbt-python-bigframes?step=1) to learn more.
