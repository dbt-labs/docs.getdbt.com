...
>This is for advanced users of dbt Cloud that are interested in expanding their knowledge of the dbt API via an interactive Postman Collection. You have a couple of options to review the collection:
>
...
>* check out the [collection documentation](https://documenter.getpostman.com/view/14183654/UVsSNiXC#auth-info-7ad22661-8807-406b-aec0-34a46b671aac). 
>
>We only suggest diving into this once you have a strong knowledge of dbt + dbt Cloud.
