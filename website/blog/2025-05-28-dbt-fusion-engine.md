...
- **To use the VS Code extension:** [Install the "dbt" extension](/docs/local/install-dbt) directly from the marketplace for automated setup and head to the quickstart. This will also automatically install the Fusion-powered CLI for you.
