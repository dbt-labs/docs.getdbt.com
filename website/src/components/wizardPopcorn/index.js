...
// invite appears at 10 and the finale lands at 20. The counter resets after the
// finale, so the cycle repeats: game at 10, wizard at 20, game again at 30, and
...
const WizardPopcorn = ({ children = 'wizard logo' }) => {
  ...
  // zero, so the next 10 clicks offer the game again rather than skipping
  // ahead to the finale.
