...
**How do I implement contracts for my models?**<br />
...
**What are model access modifiers?**<br />
...
**What are the main benefits of implementing dbt Mesh?**<br />
...
<detailsToggle alt_header="Are there integrations between the dbt Cloud Discovery API and other data cataloging tools that would make it possible to view cross-project lineage in those tools?">
...
<detailsToggle alt_header="How does dbt handle job run logs? Can it feed them to standard monitoring tools and reports or dashboards?">
...
<detailsToggle alt_header="Can contracts be partially enforced (for example, to ensure specific columns exist and go unchanged, but allow for other columns to be added or removed)?">
...
<detailsToggle alt_header="How do user access permissions work in a dbt Mesh? Who in the organization can see which projects and models?">
...
<detailsToggle alt_header="Is it possible to request access permissions from other teams? Is there a built-in workflow for this in dbt Cloud?">
