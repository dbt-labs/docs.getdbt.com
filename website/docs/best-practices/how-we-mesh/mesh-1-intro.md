...
Organizations of all sizes rely upon <Constant name="dbt" /> to manage their data transformations, from small startups to large enterprises. At scale, it can be challenging to coordinate all the organizational and technical requirements demanded by your stakeholders within the scope of a single <Constant name="dbt" /> project.
...
The multi-project architecture helps organizations with mature, complex transformation workflows in <Constant name="dbt" /> increase the flexibility and performance of their <Constant name="dbt" /> projects. If you're already using <Constant name="dbt" /> and your project has started to experience any of the following, you're likely ready to start exploring this paradigm:
