...
- Read [How we structure our <Constant name="dbt" /> projects](/best-practices/how-we-structure/1-guide-overview) for an example and more details around organization.
