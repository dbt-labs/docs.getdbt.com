...
- 🛠️ Our current recommendations are
  ...
  :::info
  ☁️ dbt Cloud comes with the [black formatter built-in](/docs/cloud/dbt-cloud-ide/lint-format) to automatically lint and format their Python. You don't need to download or configure anything, just click `Format` in a Python model and you're good to go!
  :::
