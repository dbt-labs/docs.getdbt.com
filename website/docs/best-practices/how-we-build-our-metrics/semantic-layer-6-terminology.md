...
We'll also use a couple _new_ terms for the sake of brevity. These aren't standard or official <Constant name="dbt" />-isms, but useful for communicating meaning in the context of refactoring code for the <Constant name="semantic_layer" />:
