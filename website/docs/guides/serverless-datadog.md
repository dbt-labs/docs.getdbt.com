...
- `DBT_CLOUD_SERVICE_TOKEN`: a <Constant name="dbt" /> [personal access token](/docs/dbt-platform-apis/user-tokens) or [service account token](/docs/dbt-platform-apis/service-tokens) with at least the `Metdata Only` permission.
