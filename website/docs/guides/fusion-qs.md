...
3. Click **Install**.
4. When the prompt appears, you can register the extension now or skip it (you can register later). You can also check out [Sign in or register](/docs/sign-in-dbt-extension) or the [installation instructions](/docs/install-dbt-extension) to come back to it later.
