...
- We offer a [JDBC](/docs/dbt-platform-apis/sl-jdbc) API and [GraphQL API](/docs/dbt-platform-apis/sl-graphql). Refer to the dedicated [<Constant name="semantic_layer" /> API](/docs/dbt-platform-apis/sl-api-overview) for more technical integration details.
...
- Use the [Discovery API](/docs/dbt-platform-apis/discovery-api) to enhance the metric and build confidence in its accuracy:
...
**Stage 1 - The basic**
* Supporting and using [JDBC](/docs/dbt-platform-apis/sl-jdbc) or [GraphQL](/docs/dbt-platform-apis/sl-graphql) is the first step. Refer to the [<Constant name="semantic_layer" /> APIs](/docs/dbt-platform-apis/sl-api-overview) for more technical details. 
...
* Display metadata from [Discovery API](/docs/dbt-platform-apis/discovery-api) and other context
* Expose [saved queries](/docs/build/saved-queries), which are pre-built metrics, dimensions, and filters that <Constant name="semantic_layer" /> developers create for easier analysis. You can expose them in your application. Refer to the [JDBC](/docs/dbt-platform-apis/sl-jdbc) and [GraphQL](/docs/dbt-platform-apis/sl-graphql) APIs for syntax.
