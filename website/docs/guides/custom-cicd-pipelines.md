...
When running a CI/CD pipeline you’ll want to use a service token instead of any individual’s API key. There are [detailed docs](/docs/dbt-platform-apis/service-tokens) available on this, but below is a quick rundown (this must be performed by an Account Admin):
...
3. Click [**Service tokens**](/docs/dbt-platform-apis/service-tokens) on the left.
