...
This guide helps you upgrade your dbt packages to be [<Constant name="fusion" />](/docs/dbt/about-dbt)-compatible. A <Constant name="fusion" />-compatible package:
- Supports [<Constant name="fusion_engine" />](/docs/dbt/about-dbt) version `2.0.0`
