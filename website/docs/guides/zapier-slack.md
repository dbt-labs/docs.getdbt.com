...
## Store secrets 
In the next step, you will need the Webhook Secret Key from the prior step, and a <Constant name="dbt" /> [personal access token](/docs/dbt-platform-apis/user-tokens) or [service account token](/docs/dbt-platform-apis/service-tokens). 
...
### 5. Store secrets
In the next step, you will need either a <Constant name="dbt" /> [personal access token](/docs/dbt-platform-apis/user-tokens) or [service account token](/docs/dbt-platform-apis/service-tokens). 
