...
:::important <Constant name="core_v1" />

This guide is for creating adapters for the Python-based <Constant name="core_v1" />. For adapter creation on the Rust-based <Constant name="core_v2" />, check out our [new guide](/guides/adapter-creation-v2?step=1)
...
- Adding to the list of ["Supported Data Platforms"](/docs/supported-data-platforms#types-of-adapters) (more info below)
