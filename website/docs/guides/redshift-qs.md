...
10. Set your user credentials. These credentials will be used by <Constant name="dbt" /> to connect to Redshift. Those credentials (as provided in your CloudFormation output) will be:
    ...
    <Lightbox src="/img/redshift_tutorial/images/dbt_cloud_redshift_development_credentials.png" title="dbt - Redshift User credentials" />
