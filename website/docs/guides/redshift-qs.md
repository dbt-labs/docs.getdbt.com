...
3. Click **Next** for each page until you reach the **Select acknowledgement** checkbox. Select **I acknowledge that AWS CloudFormation might create IAM resources with custom names** and click **Create Stack**.  You should land on the stack page with a CREATE_IN_PROGRESS status.
    ...
    <Lightbox src="/img/redshift_tutorial/images/cloud_formation_in_progress.png" width="65%" title="Cloud Formation in Progress" />
...
5. Type `Redshift` in the search bar at the top and click **Amazon Redshift**.
    ...
    <Lightbox src="/img/redshift_tutorial/images/go_to_redshift.png" width="65%" title="Click on Redshift" />
...
<Lightbox src="/img/redshift_tutorial/images/cluster_overview.png" width="65%" title="Available Redshift Cluster" />
...
<Lightbox src="/img/redshift_tutorial/images/redshift_query_editor.png" width="65%" title="Redshift Query Editor v2" />

<Lightbox src="/img/redshift_tutorial/images/connect_to_redshift_cluster.png" width="65%" title="Connect to Redshift Cluster" />
...
<Lightbox src="/img/redshift_tutorial/images/go_to_S3.png" width="65%" title="Go to S3" />
...
<Lightbox src="/img/redshift_tutorial/images/s3_bucket.png" width="65%" title="Go to your S3 Bucket" />

4. Click **Upload**. Drag the three files into the UI and click the **Upload** button.

<Lightbox src="/img/redshift_tutorial/images/upload_csv.png" width="65%" title="Upload your CSVs" />
...
4. Enter your Redshift settings. Reference your credentials you saved from the CloudFormation template.
    ...
    <Lightbox src="/img/redshift_tutorial/images/dbt_cloud_redshift_account_settings.png" width="65%" title="dbt Cloud - Redshift Cluster Settings" />
    </div>
...
5. Set your development credentials. These credentials will be used by dbt Cloud to connect to Redshift. Those credentials (as provided in your CloudFormation output) will be:
    ...
    <div style={{maxWidth: '400px'}}>
    <Lightbox src="/img/redshift_tutorial/images/dbt_cloud_redshift_development_credentials.png" width="65%" title="dbt Cloud - Redshift Development Credentials" />
    </div>
