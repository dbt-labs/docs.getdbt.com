...
The docs site you're on is highly searchable, make sure to explore for the answer here as a first step. If you're new to dbt, try working through the [Getting Started guide](/docs/develop/getting-started/) first to get a firm foundation on the essential concepts.
