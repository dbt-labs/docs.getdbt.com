...
We also recommend ensuring your package is compatible with [<Constant name="fusion"/>](/docs/fusion) and [<Constant name="core"/>](/docs/install-dbt). To ensure <Constant name="fusion"/> compatibility, you can follow the steps in the [Fusion package upgrade guide](/guides/fusion-package-compat).
...
If you're building a package, we recommend you ensure it's compatible with [<Constant name="fusion"/>](/docs/fusion) and [<Constant name="core"/>](/docs/install-dbt). To ensure <Constant name="fusion"/> compatibility, you can follow the steps in the [Fusion package upgrade guide](/guides/fusion-package-compat).
