...
We also recommend ensuring your package is compatible with [<Constant name="fusion"/>](/docs/introduction) and [<Constant name="core"/>](/docs/local/install-dbt). To ensure <Constant name="fusion"/> compatibility, you can follow the steps in the [dbt v2 package upgrade guide](/guides/dbt-package-compat).
...
If you're building a package, we recommend you ensure it's compatible with [<Constant name="fusion"/>](/docs/introduction) and [<Constant name="core"/>](/docs/local/install-dbt). To ensure <Constant name="fusion"/> compatibility, you can follow the steps in the [dbt v2 package upgrade guide](/guides/dbt-package-compat).
