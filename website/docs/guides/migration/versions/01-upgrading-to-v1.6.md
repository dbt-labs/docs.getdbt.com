...
- [Build your Semantic Layer](/docs/build/build-semantic-layer-intro) - Define your metrics with semantic models and MetricFlow using the command line (CLI) for dbt Core v1.6 beta. 
**Coming Soon**
