...
<Lightbox src="/img/guides/databricks-guides/deployment_monitor_dbx.png" width="65%" width="85%" title="The Deployment Monitor Shows Job Status Over Time Across Environments" />
