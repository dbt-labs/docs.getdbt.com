...
- [Initial set up steps](/guides/core-to-cloud-1?step=7#initial-set-up-steps)
...
- [Initial set up steps](/guides/core-to-cloud-1?step=8#initial-set-up-steps-1)
- [Additional configurations](/guides/core-to-cloud-1?step=8#additional-configurations)
- [CI/CD set up](/guides/core-to-cloud-1?step=8#cicd-set-up)
