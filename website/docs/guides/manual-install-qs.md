...
<Lightbox src="/img/starter-project-dbt-cli.png" width="65%" title="The starter project in a code editor" />
</div>
...
<div style={{maxWidth: '400px'}}>
<Lightbox src="/img/successful-dbt-debug.png" width="65%" title="A successful dbt debug command" />
</div>
...
<div style={{maxWidth: '400px'}}>
<Lightbox src="/img/successful-dbt-run.png" width="65%" title="A successful dbt run command" />
</div>
...
<div style={{maxWidth: '400px'}}>
<Lightbox src="/img/first-model-dbt-cli.png" width="65%" title="A successful run with the dbt Core CLI" />
</div>
...
<Lightbox src="/img/docs/dbt-cloud/deployment/run-overview.jpg" width="65%" width="90%" title="Overview of a dbt Cloud job run, which includes the job run details, trigger type, commit SHA, environment name, detailed run steps, logs, and more."/>
