...
- [Considerations](/guides/core-migration-2?step=3): Learn about the most important things you need to think about when moving from <Constant name="core" /> to Cloud.
