...
1. Retrieve **[personal access token](/docs/dbt-apis/user-tokens) **or **[Service account token](/docs/dbt-apis/service-tokens#generate-service-account-tokens) **from <Constant name="dbt" />
