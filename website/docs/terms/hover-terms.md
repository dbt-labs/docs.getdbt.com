...
sql-rendering:
  ...
  hoverSnippet: The dbt v1 engine takes SQL with Jinja, and renders all the macros present in the model to produce SQL that is ready to run against the database. For SQL parsing and compilation capabilities, use dbt v2 instead to better understand your SQL structure.
