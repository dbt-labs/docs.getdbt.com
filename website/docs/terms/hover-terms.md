...
idempotent:
  ...
  hoverSnippet: An idempotent operation produces the same result no matter how many times you run it. In dbt, this means your models should be safe to re-run and always produce consistent output — whether they've run once or a hundred times.
