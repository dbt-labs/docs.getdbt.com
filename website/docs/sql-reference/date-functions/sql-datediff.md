...
Luckily, [<Constant name="core" />](https://github.com/dbt-labs/dbt) has your back! <Constant name="core" /> is the open source dbt product that helps data folks write their [data transformations](https://www.getdbt.com/analytics-engineering/transformation/) following software engineering best practices.
