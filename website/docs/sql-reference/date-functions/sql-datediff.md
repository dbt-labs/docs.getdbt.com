...
Luckily, [dbt](https://github.com/dbt-labs/dbt-core) has your back! dbt is the product that helps data folks write their [data transformations](https://www.getdbt.com/analytics-engineering/transformation/) following software engineering best practices.
