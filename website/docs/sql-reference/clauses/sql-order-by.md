...
- (For Snowflake) Optimize the performance of large incremental models that use both a `cluster_by` [configuration](/reference/resource-configs/snowflake-configs/configuring-table-clustering#using-cluster_by) and ORDER BY statement
