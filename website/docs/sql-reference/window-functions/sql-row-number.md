...
This isn’t an extensive list of where your team may be using the ROW_NUMBER function throughout your <Constant name="dbt" /> models, but contains some common scenarios analytics engineers face day-to-day.
