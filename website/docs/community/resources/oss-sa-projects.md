...
- [<Constant name="core_v2" />](https://github.com/dbt-labs/dbt) - the next major version of dbt Core, powered by the <Constant name="fusion_engine" /> (previously in [`dbt-fusion`](https://github.com/dbt-labs/dbt-fusion))
