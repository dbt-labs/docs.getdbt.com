...
- Read the <Constant name="core" /> [contribution guide](https://github.com/dbt-labs/dbt/blob/main/CONTRIBUTING.md) and the [Contributor Expectations](/community/resources/contributor-expectations).
