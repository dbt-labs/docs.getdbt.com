...
<Lightbox src="/img-next/docs/dbt-cloud/using-dbt-cloud/project-level-artifact-updated.gif" title="Configuring Artifacts"/>
...
<Lightbox src="/img-next/docs/dbt-cloud/using-dbt-cloud/doc-menu.png" title="A link to the latest documentation for the selected job"/>
...
<Lightbox src="/img-next/docs/dbt-cloud/using-dbt-cloud/data-sources.png" title="A link to the latest source freshness snapshot for the selected job"/>
