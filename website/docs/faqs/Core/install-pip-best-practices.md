...
python3 -m venv <Constant name="dbt" />-env				# create the environment
source <Constant name="dbt" />-env/bin/activate			# activate the environment for Mac and Linux
<Constant name="dbt" />-env\Scripts\activate			# activate the environment for Windows
```
...
Before installing <Constant name="dbt" />, make sure you have the latest versions:
