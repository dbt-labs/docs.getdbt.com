---
title: "What are the best practices for installing dbt v1 with pip?"
description: "Instructions on how to install dbt v1 with pip"
sidebar_label: 'Installing dbt v1 with pip'
id: install-pip-best-practices.md
---

:::info
<Constant name="fusion_engine" /> is a next-generation, Rust-based engine that powers dbt development across the platform and local tooling. See [<Constant name="fusion_engine" />](/docs/introduction) for more information.
:::
