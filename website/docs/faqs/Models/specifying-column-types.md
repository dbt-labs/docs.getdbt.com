...
* Rather than enforcing uniqueness and not-null constraints on your column, use <Constant name="dbt" />'s [data testing](/docs/build/data-tests) functionality to check that your assertions about your model hold true.
