...
To learn more about building a dbt project, we recommend you complete the [Getting Started guide](/docs/get-started/getting-started/getting-started-dbt-cloud).
