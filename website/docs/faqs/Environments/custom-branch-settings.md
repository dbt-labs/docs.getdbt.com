...
<Lightbox src="/img/docs/dbt-cloud/cloud-configuring-dbt-cloud/dev-environment-custom-branch.png" width="65%" width="70%" title="Configuring a custom base repository branch"/>
