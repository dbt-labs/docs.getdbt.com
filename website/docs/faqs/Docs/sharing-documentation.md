...
Access <Constant name="catalog" /> in <Constant name="dbt" /> by clicking the **Catalog** link in the navigation. Read-only users can access the documentation for your project &mdash; for license availability by plan, refer to [dbt pricing](https://www.getdbt.com/pricing).
