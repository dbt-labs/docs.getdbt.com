...
* **Getting Started Tutorial:** You can build your own example dbt project in the [Getting Started guide](/docs/develop/getting-started/getting-started-dbt-cloud)
