...
If you're receiving an 'Account in use' error when trying to integrate GitHub in your Profile page, this is because the <Constant name="git" /> integration is a 1-to-1 integration, so you can only have your <Constant name="git" /> account linked to one <Constant name="cloud" /> user account. 
