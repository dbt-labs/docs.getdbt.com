...
3. Restart the <Constant name="cloud_ide" /> by clicking on the three dots next to the **<Constant name="cloud_ide" /> Status button** on the lower right of the <Constant name="cloud_ide" />.
...
5. Go back to your <Constant name="dbt" /> project and delete the following files or folders if you have them:
