...
The root cause is typically the proxy interfering with the TLS handshake as the <Constant name="dbt" /> <Constant name="semantic_layer" /> uses gRPC/HTTP2 for connectivity. To resolve this:
