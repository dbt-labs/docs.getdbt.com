...
If you see a `authentication has expired` error when you try to run queries in the <Constant name="cloud_ide" />, this means your [OAuth](/docs/cloud/manage-access/set-up-snowflake-oauth) connection between Snowflake and <Constant name="cloud" /> has expired.
