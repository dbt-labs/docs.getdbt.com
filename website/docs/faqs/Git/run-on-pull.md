...
If it was added via a deploy key method, you'll want to use the [GitHub auth method](https://docs.getdbt.com/docs/cloud-installing-the-github-application) to enable CI in <Constant name="cloud" />.

To go ahead and enable 'Run on Pull requests', you'll want to remove <Constant name="cloud" /> from the Apps & Integration on GitHub and re-integrate it again via the GitHub app method.
