...
Below is a guide for use with "Synapse Data Warehouse" a new product within Microsoft Fabric ([more info](https://learn.microsoft.com/en-us/fabric/data-warehouse/data-warehousing#synapse-data-warehouse))
