...
* You understand which database adapter(s) you need. For more information, see [About dbt adapters](installation-overview.md#about-dbt-data-platforms-and-adapters).
