...
| **Organize tabs**  | - You can move your tabs around to reorganize your work in the IDE <br /> - Right-click on a tab to view and select a list of actions to take <br /> - And also close multiple, unsaved tabs to batch save your work
