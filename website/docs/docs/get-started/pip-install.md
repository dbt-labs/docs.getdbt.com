...
You need to use `pip` to install dbt Core on Windows or Linux operating systems. You should use [Homebrew](/docs/develop/homebrew-install) for installing dbt Core on a MacOS.
