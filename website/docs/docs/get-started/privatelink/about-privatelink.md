...
---
:::info 
This feature is currently in Private Preview, and these instructions are specific to dbt Cloud multi-tenant environments on AWS on the Enterprise pricing tier. 
:::
