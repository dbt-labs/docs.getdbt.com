...
You will define the number of threads in your `profiles.yml` file (for dbt Core users only), <Constant name="cloud" /> job definition, and <Constant name="cloud" /> development credentials under your profile.
