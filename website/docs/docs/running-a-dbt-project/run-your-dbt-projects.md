...
The <Constant name="cloud" /> CLI and <Constant name="core" /> are both command line tools that enable you to run <Constant name="dbt" /> commands. The key distinction is the <Constant name="cloud" /> CLI is tailored for <Constant name="cloud" />'s infrastructure and integrates with all its [features](/docs/cloud/about-cloud/dbt-cloud-features).
...
- [<Constant name="dbt" /> run](/reference/commands/run) &mdash; Runs the models you defined in your project
- [<Constant name="dbt" /> build](/reference/commands/build) &mdash; Builds and tests your selected resources such as models, seeds, snapshots, and tests
- [<Constant name="dbt" /> test](/reference/commands/test) &mdash; Executes the tests you defined for your project
...
- [How we set up our computers for working on <Constant name="dbt" /> projects](https://discourse.getdbt.com/t/how-we-set-up-our-computers-for-working-on-dbt-projects/243)
...
- [Does <Constant name="dbt" /> offer extract and load functionality?](/faqs/Project/transformation-tool)
- [Why does <Constant name="dbt" /> compile need a data platform connection](/faqs/Warehouse/db-connection-dbt-compile)
