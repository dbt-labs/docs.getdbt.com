...
You can refer to [Getting Started with dbt Cloud](/docs/develop/getting-started) to quickly get set up and perform some key tasks. For more information, see the following articles.
