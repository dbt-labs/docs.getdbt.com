...
The example query below could be useful if we wanted to understand more information about the columns of a given model.  Note that this will only work if the job generated documentation (for example, with command 'dbt docs generate').
