...
_Note that this API is currently not available to accounts on [Single Tenant deployments](https://docs.getdbt.com/docs/dbt-cloud/deployments/single-tenant-deployment)._
