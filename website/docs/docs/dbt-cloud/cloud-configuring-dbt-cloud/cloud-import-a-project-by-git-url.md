...
<Callout type="info" title="Use GitHub?">
...
To add a deploy key to a BitBucket account, navigate to "SSH keys" tab in the User Settings page of your BitBucket account. Next, click the "Add key" button and paste in the deploy key generated by dbt Cloud for your repository. After saving this SSH key, dbt Cloud will be able to read and write files in your BitBucket repository.

<Lightbox src="/img/docs/dbt-cloud/cloud-configuring-dbt-cloud/e7ae24e-Screen_Shot_2019-10-16_at_4.45.17_PM.png" title="Configuring a BitBucket SSH Key"/>
