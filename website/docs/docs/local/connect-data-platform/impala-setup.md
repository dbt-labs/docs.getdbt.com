...
Relatedly, if you'd like to turn off dbt Labs' anonymous usage tracking, refer to [Anonymous usage stats](/reference/global-configs/usage-stats) for more details.
