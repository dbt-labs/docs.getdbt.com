...
pagination_next: "docs/local/pip-install"
...
- [Use pip to install dbt](/docs/local/pip-install) (recommended)
- [Use a Docker image to install dbt](/docs/local/docker-install)
- [Install dbt from source](/docs/local/source-install)
...
- [Upgrade `pip`](/docs/local/pip-install#change-dbt-core-versions)
