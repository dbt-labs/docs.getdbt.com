...
<Lightbox src="/img/docs/dbt-platform/using-dbt-cloud/data-sources-next.png" title="Data Sources in dbt"/>
...
<Lightbox src="/img/docs/dbt-platform/using-dbt-cloud/job-step-source-freshness.png" title="Adding a step to snapshot source freshness"/>
