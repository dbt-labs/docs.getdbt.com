...
<Lightbox src="/img/docs/dbt-cloud/using-dbt-cloud/data-sources-next.png" width="65%" title="Data Sources in dbt Cloud"/>
...
<Lightbox src="/img/docs/dbt-cloud/select-source-freshness.png" width="65%" title="Selecting source freshness"/>
...
<Lightbox src="/img/docs/dbt-cloud/using-dbt-cloud/job-step-source-freshness.png" width="65%" title="Adding a step to snapshot source freshness"/>
