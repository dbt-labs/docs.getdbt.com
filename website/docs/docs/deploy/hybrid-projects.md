...
description: "Learn how to upload dbt v1 artifacts into the dbt platform to create and set up hybrid projects."
...
- Updated your existing <Constant name="core" /> project with latest changes and [configured it with model access](/docs/deploy/hybrid-setup#make-dbt-models-public):
