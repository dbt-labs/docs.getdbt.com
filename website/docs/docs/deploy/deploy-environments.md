...
You can also leverage the dbt Job scheduler to [test your metrics in a CI job](/docs/deploy/ci-jobs#test-metrics-in-ci) to ensure code changes made to dbt models don't break these metrics.
