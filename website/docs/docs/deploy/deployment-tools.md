...
The following steps provides you with a detailed overview of how to trigger a <Constant name="dbt" /> job via the API in Azure Data Factory. To use the dbt API to trigger a job in <Constant name="dbt" /> through ADF:
