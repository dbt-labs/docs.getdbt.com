...
Every job invocation automatically includes [`dbt deps`](/reference/commands/deps) and `dbt build`, meaning you don't need to add it to the **Commands** list in your job settings. 
