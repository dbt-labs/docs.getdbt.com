...
<Lightbox src ="/img/docs/dbt-platform/using-dbt-cloud/job-commands.gif" width="85%" title="Configuring checkbox and commands list"/>
...
<Lightbox src="/img/docs/dbt-platform/using-dbt-cloud/fail-dbtdeps.png" width="85%" title="A failed job that had an error during the dbt deps run step."/>
...
<Lightbox src ="/img/docs/dbt-platform/using-dbt-cloud/skipped-jobs.png" width="85%" title="A failed job run that had an error during a run step"/>
