...
1. Check your dbt version by running `dbt --version` and you should see the following:
   ...
   ```
2. If you don't have the latest version (1.10 or later), [upgrade](/docs/local/pip-install#change-dbt-core-versions) your dbt Core project by running `python -m pip install --upgrade dbt-core`.
