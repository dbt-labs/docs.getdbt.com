...
5. After creating a project, create a corresponding [production environment](/docs/deploy/deploy-environments#create-a-deployment-environment) and click **Save**. You will need to create a placeholder profile and assign it to the environment to save. 
