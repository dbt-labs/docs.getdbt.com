...
[<Constant name="core" /> and <Constant name="fusion_engine" /> ](/docs/about-dbt-install) provide command-line tools that enables data practitioners to transform data using analytics engineering best practices. It suits individuals and small technical teams who prefer manual setup and customization, supports community adapters, and open-source standards.
