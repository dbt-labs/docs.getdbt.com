...
- The Fusion CLI and VS Code extension are free to use. Some advanced capabilities — like state-aware orchestration and Advanced CI — are exclusively available for paying customers of the [dbt platform](https://www.getdbt.com/pricing). Refer to [supported features](/docs/fusion/supported-features#paid-features) for more information.
