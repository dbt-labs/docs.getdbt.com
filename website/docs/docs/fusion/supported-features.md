...
Here are some additional considerations if using the Fusion CLI without the VS Code extension or the VS Code extension without the Fusion CLI:
    ...
    - **dbt VS Code extension**
      - Free to use and runs on the <Constant name="fusion_engine" />. We recommend registering your email to connect your dbt organization — the extension works immediately whether or not you've registered.
