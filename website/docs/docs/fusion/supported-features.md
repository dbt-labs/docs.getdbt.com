...
For a full reference of Snowflake functions with Fusion typechecking support, see [Snowflake function support](/reference/resource-configs/snowflake-function-support).
