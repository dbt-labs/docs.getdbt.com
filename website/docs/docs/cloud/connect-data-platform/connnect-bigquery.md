...
| [Notebook Template ID](#notebook-template-id)          | BigQuery Dataframe only, Unique identifier to a Colab Enterprise notebook runtime          | Integer  | `7018811640745295872`                |
| [Compute Region](#compute-region)          | BigQuery Dataframe only, assigns the compute region of the notebook runtime          | String  | `US`, `EU`, `asia-northeast1`              |
