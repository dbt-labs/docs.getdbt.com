...
- [Build queries](#build-queries) <Lifecycle status="beta"/> &mdash; Use <Constant name="copilot" /> to generate queries in the [<Constant name="query_page" />](/docs/collaborate/query-page) for exploratory data analysis using natural language prompts.
