...
Stay tuned! Coming very soon, you'll be able to version control your dbt modes in the <Constant name="visual_editor" />. This ensures you can track changes and revert to previous versions if needed.
