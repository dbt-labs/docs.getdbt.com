...
You can address deprecation warnings in <Constant name="dbt_platform" /> by finding and fixing them using the autofix tool in the <Constant name="cloud_ide" />. You can run the autofix tool before you upgrade to Fusion!
