...
- AI copilot &mdash; Use [dbt Copilot](/docs/cloud/dbt-assist), a powerful AI feature to generate documentation and tests for your dbt SQL models.
...
| [**dbt Copilot**](/docs/cloud/dbt-assist) <Lifecycle status='beta' />| A powerful AI copilot feature that generates documentation and tests for your dbt SQL models. Available for [dbt Cloud Enterprise plans](https://www.getdbt.com/pricing). |
