...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-basic-layout.jpg" width="65%" width="100%" title="The Cloud IDE layout includes version control on the upper left, files/folders on the left, editor on the right an command/console at the bottom"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-side-menu.jpg" width="65%" width="30%" title="The Git repo link, documentation site button, Version Control menu, and File Explorer"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-command-bar.jpg" width="65%" width="120%" title="Use the Command bar to write dbt commands, toggle 'Defer', and view the current IDE status"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-editing.jpg" width="65%" width="100%" title="Use the file editor, version control section, and save button during your development workflow"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/version-control-options-menu.png" width="65%" width="30%" title="Right-click edited files to access Version Control Options menu"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-minimap.jpg" width="65%" width="100%" title="Use the Minimap for quick navigation and code understanding"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-editor-command-palette-with-save.jpg" width="65%" width="100%" title="Click F1 to access the dbt Editor Command Palette menu for editor shortcuts"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-git-diff-view-with-save.jpg" width="65%" width="100%" title="The Git Diff View displays the previous version on the left and the changes made on the right of the Editor"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-markdown-with-save.jpg" width="65%" width="100%" title="The Markdown Preview console tab renders markdown code below the Editor tab."/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-csv.jpg" width="65%" width="100%" title="View csv code in the CSV Preview console tab below the Editor tab."/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-console-overview.jpg" width="65%" width="100%" title="The Console section is located below the File editor and has various tabs and buttons to help execute tasks"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/results-console-tab.jpg" width="65%" width="100%" title="Preview results show up in the Results console tab"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/compiled-code-console-tab.jpg" width="65%" width="100%" title="Compile results show up in the Compiled Code tab"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/lineage-console-tab.jpg" width="65%" width="100%" title="View resource lineage in the Lineage tab"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-inv-history-drawer.jpg" width="65%" width="100%" title="The Invocation History Drawer returns a log and detail of all your dbt Cloud invocations."/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-results.jpg" width="65%" width="100%" title="The Invocation History list displays a list of previous invocations in the IDE"/>
...
- **Editor tab menu &mdash;** To interact with open editor tabs, right-click any tab to access the helpful options in the file tab menu.<Lightbox src="/img/docs/dbt-cloud/cloud-ide/editor-tab-menu-with-save.jpg" width="65%" width="100%" title=" Right-click a tab to view the Editor tab menu options"/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-file-search-with-save.jpg" width="65%" width="100%" title="The Command History returns a log and detail of all your dbt Cloud invocations."/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-global-command-palette-with-save.jpg" width="65%" width="100%" title="The Command History returns a log and detail of all your dbt Cloud invocations."/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-status-modal-with-save.jpg" width="65%" width="100%" title="The Command History returns a log and detail of all your dbt Cloud invocations."/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/commit-changes-modal.png" width="65%" width="100%" title="The Commit Changes modal is how users commit changes to their branch."/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/change-branch-modal.png" width="65%" width="100%" title="The Commit Changes modal is how users change their branch."/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/revert-uncommitted-changes-with-save.jpg" width="65%" width="100%" title="The Commit Changes modal is how users change their branch."/>
...
<Lightbox src="/img/docs/dbt-cloud/cloud-ide/ide-options-menu-with-save.jpg" width="65%" width="85%" title="Access the IDE Options menu to switch to dark or light mode, restart the IDE, reclone your repo, or view the IDE status"/>
