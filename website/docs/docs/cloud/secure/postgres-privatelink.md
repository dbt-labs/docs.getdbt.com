...
<Lightbox src="/img/docs/dbt-cloud/redshiftprivatelink5.png" width="65%" width="70%" title="Enter ARN"/>
...
<Lightbox src="/img/docs/dbt-cloud/redshiftprivatelink6.png" width="65%" width="70%" title="Get service name field value"/>
