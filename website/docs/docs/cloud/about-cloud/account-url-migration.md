...
- All access URLs for the <Constant name="dbt_platform" />, Discovery/Metadata API, and Semantic Layer
...
| Admin API, Metadata API, Semantic Layer API | Update access URLs in your API clients |
