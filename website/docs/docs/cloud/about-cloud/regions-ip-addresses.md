...
| Region | Location | <div style={{width:'110px'}}>Access URL</div> | <div style={{width:'100px'}}>IP addresses</div> | Available plans | <div style={{width:'200px'}}>Status page link</div> |
|--------|----------|------------|--------------|-------| --------- |
| North America  | us-central1 | <small>ACCOUNT_PREFIX.us3.dbt.com</small> | 34.23.226.0/26 | All Enterprise plans | [US Cell 1 GCP](https://status.getdbt.com/us-cell-1-gcp) | 
