...
| [**<Constant name="dev_agent" />**](/docs/dbt-ai/developer-agent) | Autonomous AI agent in the <Constant name="cloud_ide" /> that writes or refactors dbt models from natural language, validates with <Constant name="fusion_engine" />, and runs against your warehouse with full context. <Lifecycle status="private_beta" />. |
