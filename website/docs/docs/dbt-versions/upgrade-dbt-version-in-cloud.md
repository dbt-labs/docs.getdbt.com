...
<Lightbox src="/img/docs/dbt-platform/cloud-configuring-dbt-cloud/choosing-dbt-version/example-environment-settings.png" width="90%" title="Example environment settings in dbt"/>
...
To upgrade an environment in the [<Constant name="dbt" /> Admin API](/docs/dbt-platform-apis/admin-cloud-api) or [Terraform](https://registry.terraform.io/providers/dbt-labs/dbtcloud/latest), set `dbt_version` to the name of your release track:
...
- Once you upgrade your development environment(s) to `Latest Fusion`, every user will have to restart the IDE.
  ...
  <Lightbox src="/img/docs/dbt-platform/cloud-configuring-dbt-cloud/cloud-upgrading-dbt-versions/upgrade-fusion.png" width="90%" title="Upgrade to the Fusion engine in your environment settings." />
...
When you're ready to upgrade your project(s) to <Constant name="fusion_engine" />, there are some tools available to you in the dbt platform UI to help you get started. The <Constant name="fusion" /> upgrade assistant will step you through the process of preparing and upgrading your projects. 
  ...
  <Lightbox src="/img/docs/dbt-platform/cloud-configuring-dbt-cloud/choosing-dbt-version/fusion-upgrade-gui.png" width="60%" title="The Fusion upgrade assistant."/>
...
4. Click **Save**.
  ...
  <Lightbox src="/img/docs/dbt-platform/cloud-configuring-dbt-cloud/choosing-dbt-version/assign-fusion-admin.png" width="60%" title="Assign Fusion admin to groups and projects."/>
...
1. From the project homepage or sidebar menu, click the **Start Fusion upgrade** or **Get started** button. You will be redirected to the <Constant name="studio_ide" />.
  <Lightbox src="/img/docs/dbt-platform/cloud-configuring-dbt-cloud/choosing-dbt-version/start-upgrade.png" width="60%" title="Start the Fusion upgrade."/>
2. At the top of the <Constant name="studio_ide" /> click **Check deprecation warnings**. 
  <Lightbox src="/img/docs/dbt-platform/cloud-configuring-dbt-cloud/choosing-dbt-version/check-deprecations.png" width="60%" title="Begin the process of parsing for deprecation warnings."/>
...
4. Once the deprecation warnings have been resolved, click the **Enable Fusion** button. This upgrades your development environment to Fusion!
  ...
  <Lightbox src="/img/docs/dbt-platform/cloud-configuring-dbt-cloud/choosing-dbt-version/autofix-success.png" width="60%" title="You're now ready to upgrade to Fusion in your development environment!"/>
...
<Lightbox src="/img/docs/dbt-platform/cloud-configuring-dbt-cloud/choosing-dbt-version/job-settings.png" width="200%" title="Settings of a dbt job"/>
...
<Lightbox src="/img/docs/dbt-platform/cloud-configuring-dbt-cloud/cloud-upgrading-dbt-versions/upgrade-environment.png" width="90%" title="Setting your testing environment" />
