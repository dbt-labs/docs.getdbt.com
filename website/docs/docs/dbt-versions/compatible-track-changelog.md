...
- [dbt-athena 1.10.0](https://github.com/dbt-labs/dbt-adapters/blob/main/dbt-athena/CHANGELOG.md)
- [dbt-bigquery 1.11.0](https://github.com/dbt-labs/dbt-adapters/blob/main/dbt-bigquery/CHANGELOG.md)
...
- [dbt-postgres 1.10.0](https://github.com/dbt-labs/dbt-adapters/blob/main/dbt-postgres/CHANGELOG.md#changelog)
- [dbt-redshift 1.10.1](https://github.com/dbt-labs/dbt-adapters/blob/main/dbt-redshift/CHANGELOG.md#changelog)
- [dbt-snowflake 1.11.2](http://github.com/dbt-labs/dbt-adapters/blob/main/dbt-snowflake/CHANGELOG.md)
- [dbt-spark 1.10.1](https://github.com/dbt-labs/dbt-adapters/blob/main/dbt-spark/CHANGELOG.md#changelog)
