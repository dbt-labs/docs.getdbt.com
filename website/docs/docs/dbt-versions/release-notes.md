...
- **Beta**: DuckDB is now supported in the dbt Fusion engine CLI, enabling faster compilation and execution for DuckDB-based dbt projects. For more information, refer to [Connect DuckDB to Fusion](/docs/local/connect-data-platform/duckdb-setup).
