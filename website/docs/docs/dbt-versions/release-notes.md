...
## August 2024
**Fix:** Fixed an issue in Explorer where navigating to a consumer project from a public node resulted in a random public model being displayed rather than the original selection. 
