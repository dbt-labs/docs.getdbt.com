...
## August 2024
- **Behavior change:** Github is _no longer supported_ for Oauth login to dbt Cloud. Use a supported [SSO or Oauth provider](/docs/cloud/manage-access/sso-overview) to securely manage access to your dbt Cloud account.
