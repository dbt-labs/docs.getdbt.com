...
-**New**: The Trino adapter now fully supports <Constant name="semantic _layer" />, including metrics, dimensions, and integration with BI tools via the Discovery API.
