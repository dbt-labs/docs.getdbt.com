...
- **Studio IDE: Copilot link in console toolbar**: Adds a link that opens Copilot from the console toolbar. You an use Copilot to read files and list directories for better context.
