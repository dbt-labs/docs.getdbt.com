...
- **dbt cloud CLI server – Artifact streaming**: Artifact downloads now stream directly from object storage (including gzipped blobs), speeding retrieval and lowering memory pressure on CLI workers. <!-- https://github.com/dbt-labs/dbt-cloud-cli-server/commit/871e280694087e21ea3d5a7ca84d6805e6799450 -->
- **IDE server – Copilot & logging fidelity**: AI Copilot requests now carry the IDE environment ID end-to-end and run logs ingest Fusion `NodeProcessed` signals so “skipped” vs. “aborted” steps and hidden `show` previews display accurately. <!-- https://github.com/dbt-labs/ide-server/commit/239863005992ff39687cc337e2f113ba9c0bb512 -->
...
- **Studio – Console & editing UX**: IDE Next’s console pane now houses the unified command drawer, a new ANSI-aware log viewer (behind `xp3739NewStudioLogComponent`) adds filtering/downloading, and formatting/minimap/word-wrap toggles sync with VS Code-backed user settings for predictable edits. <!-- https://github.com/dbt-labs/studio/compare/7eb6e566274fe08bf1cf7dc30e8c0ca2dd6571e8...11ed3b092efe17a745062af5a100a25077182f08 -->
...
- **IDE server – VCS errors**: Branch creation now returns explicit `invalid_spec` feedback for bad branch names/SHAs and detects unauthorized Git errors earlier, making automation failures actionable. <!-- https://github.com/dbt-labs/ide-server/commit/239863005992ff39687cc337e2f113ba9c0bb512 -->
