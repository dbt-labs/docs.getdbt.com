...
### Functionality now native to <Constant name="core" />:
...
```
**Note** &mdash; This may cause some tests to get the same autogenerated names. To resolve this, you can [define a custom name for a test](/reference/resource-properties/data-tests#custom-data-test-name).
...
<details>
	...
	<div>
		...
		<p><b>Resolution</b>: Define a <a href="https://docs.getdbt.com/reference/resource-properties/tests#custom-data-test-name">custom name for your test</a>.</p>
	</div>
</details>
