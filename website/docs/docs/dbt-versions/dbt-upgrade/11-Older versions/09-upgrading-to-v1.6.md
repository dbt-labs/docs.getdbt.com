...
The [spec for metrics](https://github.com/dbt-labs/dbt-oss/discussions/7456) has changed and now uses [MetricFlow](/docs/build/about-metricflow). 
...
- dbt Labs is ending support for Homebrew installation of <Constant name="core" /> and adapters. See [the discussion](https://github.com/dbt-labs/dbt-oss/discussions/8277) for more details.
...
For more detailed information and to ask questions, please read and comment on the GH discussion: [dbt-labs/<Constant name="core" />#7958](https://github.com/dbt-labs/dbt-oss/discussions/7958).
