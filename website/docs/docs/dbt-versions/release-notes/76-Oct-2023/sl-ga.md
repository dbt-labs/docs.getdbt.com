...
<Lightbox src="/img/docs/dbt-cloud/semantic-layer/sl-architecture.jpg" width="65%" width="80%" title="Use the universal dbt Semantic Layer to define and queried metrics in integration tools."/>
