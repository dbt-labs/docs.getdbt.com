...
description: "dbt Catalog provides recommendations that you can take to improve the quality of your dbt project."
---

# Project recommendations <Lifecycle status="managed,managed_plus" />
 
<Constant name="catalog" /> provides recommendations about your project from the `dbt_project_evaluator` [package](https://hub.getdbt.com/dbt-labs/dbt_project_evaluator/latest/) using metadata from the [Discovery API](/docs/dbt-platform-apis/discovery-api). 
