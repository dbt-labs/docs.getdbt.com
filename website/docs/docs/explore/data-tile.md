...
3. Add a new Text or Markdown [element](https://docs.omni.co/visualize-present/dashboards/text-markdown) in your Dashboard with the code from step 2, it should be in the following format:
   ...
   ```html/text
    ...
    ```
5. Save the tile and your Omni dashboard should now have a <Constant name="dbt_platform" /> hosted data health tile that is automatically updated based on the state of your dbt environment.
