...
<Expandable alt_header="Can I use dbt Catalog on-premises or with my self-hosted v1 deployment?" >
...
<Expandable alt_header="Will v1 users be able to leverage any of these new dbt Catalog features?" >
