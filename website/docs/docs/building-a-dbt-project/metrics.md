...
For a short human-friendly name with title casing, spaces, and special characters, use the `label` property. More examples and guidance in how to [define and structure metrics can be found here](https://docs.getdbt.com/blog/how-to-design-and-structure-metrics).
