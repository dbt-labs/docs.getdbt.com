...
2. If you created a new account, a new project should automatically be created. If you were added to an existing account:
    * Click the gear icon in the top right of the screen, then `Projects` underneath your Account Settings.
...
4. Go to the `Develop` interface by clicking on the `Develop` tab in the top navigation.
