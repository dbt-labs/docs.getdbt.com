...
* [In-depth discussion of granting privileges using hooks and operations, for older versions of dbt](https://discourse.getdbt.com/t/the-exact-grant-statements-we-use-in-a-dbt-project/430)
