...
id: "wizard-overview"
description: "dbt Wizard is an AI agent purpose-built for governed data development in dbt — available in dbt platform, Wizard Desktop, and from your terminal."
...
<Constant name="wizard" /> is for anyone developing with or exploring dbt. You can use it in <Constant name="dbt_platform" />, locally in your terminal or IDE, or through the [Wizard Desktop](/docs/dbt-ai/wizard-desktop) native app, where rich data visualizations, data diffs, and lineage render alongside the chat. <Constant name="wizard" /> works with any data warehouse and [dbt version](/docs/introduction#dbt-versions).

<Constant name="wizard" /> is also for people who don’t develop data models. In <Constant name="dbt_platform" />, [Explore mode](/docs/dbt-ai/wizard-ide#agent-modes) lets [read-only users](/docs/platform/wizard-read-only-users) ask questions about production data in plain language with no developer license or setup.
...
| [<Constant name="dbt_platform" />: Wizard home tab](/docs/platform/wizard-home) | Public preview | dbt <Term id="managed" /> or BYOK |
| [Locally: Wizard terminal (CLI)](/docs/dbt-ai/wizard-cli) | Public beta | dbt <Term id="managed" />, BYOK, or OpenAI subscription |
| [Locally: Wizard Desktop](/docs/dbt-ai/wizard-desktop) | Private beta | dbt <Term id="managed" /> or BYOK |
...
You can get started with Wizard wherever you work, whether it's the terminal or <Constant name="dbt_platform" />:
...
A terminal-based agent for governed data development in dbt, whether your team uses <Constant name="dbt_platform" /> or self-hosts. Bring your own key to experience the full agentic analytics engineering loop.

<WizardCliInstall />
<NewToTerminal />

### Wizard Desktop <Lifecycle status="private_beta"/>
...
To learn more, refer to [Get started with Wizard Desktop](/docs/dbt-ai/wizard-desktop).
...
1. Sign in to [<Constant name="dbt_platform" />](https://www.getdbt.com/signup), or create a free account if you don't have one yet.
...
- [Use skills in dbt platform](/docs/dbt-ai/wizard-platform-skills) — give dbt Wizard reusable instructions for your project
