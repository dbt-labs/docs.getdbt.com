...
| [Terminal (CLI)](/docs/dbt-ai/wizard-cli) | Public beta | BYOK, or OpenAI subscription | <Constant name="dbt" /> doesn't meter CLI usage — you pay your AI provider directly. Works with or without a <Constant name="dbt_platform" /> account. |
