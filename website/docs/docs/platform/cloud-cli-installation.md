...
The <Constant name="platform_cli" /> and <a href="https://github.com/dbt-labs/dbt"><Constant name="core" /></a>, an open-source project, are both command line tools that enable you to run dbt commands. 
