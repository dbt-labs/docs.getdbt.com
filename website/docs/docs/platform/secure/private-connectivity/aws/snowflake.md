...
### Self-serve private endpoints <Lifecycle status="public_beta" />

:::note
Self-serve private endpoints are currently in public beta for Snowflake on AWS. If you run into issues or have feedback, please contact support@dbtlabs.com.
