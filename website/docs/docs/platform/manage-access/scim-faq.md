...
SCIM license mapping with Entra ID may be possible using custom attributes, depending on your Entra ID configuration. Because this setup varies by environment, we don't provide a standard configuration or troubleshooting guidance for it &mdash; **do it at your own risk**.
