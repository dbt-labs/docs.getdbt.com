...
For complete setup instructions, refer to [Set up read-only user access](/docs/platform/manage-access/about-user-access#enable-granular-permissions-for-read-only-users) for the full setup steps.
