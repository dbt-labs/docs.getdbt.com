...
If you set up SSO before Dec 2025, you may need to request `Directory.Read.All` instead. Alternatively, delete and re-create your SSO configuration to use the new targeted scopes above.
:::
