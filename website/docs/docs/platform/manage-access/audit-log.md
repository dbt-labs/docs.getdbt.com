...
<Lightbox src="/img/docs/dbt-platform/dbt-cloud-enterprise/audit-log-search.png" width="95%" title="Use search bar to find content in the audit log"/>
...
<Lightbox src="/img/docs/dbt-platform/dbt-cloud-enterprise/audit-log-section.png" width="95%" title="View audit log export options"/>
