...
- Read-only access to connections (account and project), metadata, projects, repositories, <Constant name="semantic_layer" /> configuration, environments, and custom environment variables.
