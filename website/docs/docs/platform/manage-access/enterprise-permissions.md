...
- Admins can configure [environment write access](/docs/platform/manage-access/environment-permissions-setup) for this role to scope which environment types users can create and run jobs in.
