...
- The Tableau SDK doesn't currently display descriptive labels defined in your `metrics` configuration. This means that any custom labels you assign to your metrics won't be visible when those metrics are imported/queried into Tableau. This is a current limitation to avoid any breaking changes and may change in future updates.
