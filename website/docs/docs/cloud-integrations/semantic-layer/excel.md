...
The <Constant name="dbt" /> <Constant name="semantic_layer" /> offers a seamless integration with Excel Online and Desktop through a custom menu. This add-on allows you to build <Constant name="dbt" /> <Constant name="semantic_layer" /> queries and return data on your metrics directly within Excel.
