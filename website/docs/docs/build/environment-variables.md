...
<Lightbox src="/img/docs/dbt-platform/using-dbt-cloud/Environment Variables/job-override.gif" title="Navigating to environment variables job override settings"/>
...
<Lightbox src="/img/docs/dbt-platform/using-dbt-cloud/Environment Variables/job-override.png" title="Setting a job override value"/>
...
<Lightbox src="/img/docs/dbt-platform/using-dbt-cloud/Environment Variables/personal-override.png" width="60%" title="Setting a personal override value"/>
...
<Lightbox src="/img/docs/dbt-platform/using-dbt-cloud/Environment Variables/refresh-ide.png" title="Refreshing IDE mid-session"/>
...
<Lightbox src="/img/docs/dbt-platform/using-dbt-cloud/Environment Variables/DBT_ENV_SECRET.png" title="DBT_ENV_SECRET prefix obfuscation"/>
...
<Lightbox src="/img/docs/dbt-platform/using-dbt-cloud/Environment Variables/warehouse-override.png" width="60%" title="Adding environment variables to your connection credentials"/>
