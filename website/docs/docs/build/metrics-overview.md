...
- When querying, pick the rollup grain (day/week/month/year) in your BI tool or with the [Semantic Layer API](/docs/dbt-platform-apis/sl-api-overview). You can only roll up to grains coarser than or equal to the column’s native grain.
