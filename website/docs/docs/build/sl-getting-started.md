...
This guide uses [MetricFlow dbt Cloud commands](/docs/build/metricflow-cloud). If you're using dbt Core, refer to [MetricFlow dbt Core](/docs/build/metricflow-core) for relevant commands.
