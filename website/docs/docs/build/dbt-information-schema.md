...
You can also use this as the data source for [project checks](/docs/build/project-checks), which let you enforce standards and quality rules across your project.
