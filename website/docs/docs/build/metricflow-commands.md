...
Once you define metrics in your dbt project, you can query metrics, dimensions, and dimension values, and validate your configs using the MetricFlow commands, available across the <Constant name="core" /> or [<Constant name="fusion_engine" />](/docs/dbt/about-dbt). To upgrade to <Constant name="fusion"/>, see [Get started with <Constant name="fusion"/>](/docs/dbt/get-started-dbt). 
