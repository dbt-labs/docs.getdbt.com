...
Alternatively, you can define a single-column [surrogate key](https://docs.getdbt.com/terms/surrogate-key), for example with [`dbt_utils.surrogate_key`](https://github.com/dbt-labs/dbt-utils#surrogate_key-source).
:::
