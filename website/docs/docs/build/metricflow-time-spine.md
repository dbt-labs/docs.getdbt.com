...
- [The `custom_granularities` field](#custom-calendar), (available in <Constant name="dbt" /> Latest and <Constant name="core" /> v1.9 and higher) lets you specify non-standard time periods like `fiscal_year` or `retail_month` that your organization may use.
