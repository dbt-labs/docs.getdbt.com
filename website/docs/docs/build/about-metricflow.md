...
- MetricFlow is developed and maintained by <Constant name="dbt" /> as part of the [Open Semantic Interchange (OSI)](https://www.snowflake.com/en/blog/open-semantic-interchange-ai-standard/) initiative. Starting in <Constant name="core" /> v1.12, you can also define semantic models using [OSI documents](/docs/build/osi-semantic-models) as an alternative to dbt's native YAML configuration.
