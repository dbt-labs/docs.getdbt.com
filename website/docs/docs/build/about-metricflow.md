...
- You can install the MetricFlow CLI as an extension of your [dbt adapter](/docs/supported-data-platforms) in the CLI. When you install the adapter, add your adapter name at the end of the command. For example, for a Snowflake adapter, run `pip install "dbt-metricflow[snowflake]"`.
