...
id: "semantic-models"
description: "Semantic models are YAML abstractions on top of a dbt model, connected via joining keys as edges"
keywords:
  - dbt metrics layer
...
- You can also define semantic models using [Apache Ossie](https://github.com/apache/ossie) documents, an alternative to <Constant name="core" />'s native YAML configuration. For more information, refer to [Ossie semantic layer documents](/docs/build/osi-semantic-models).
