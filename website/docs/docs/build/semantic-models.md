...
- You can also define semantic models using [Apache Ossie](https://github.com/apache/ossie) documents, an alternative to dbt's native YAML configuration. For more information, refer to [Ossie semantic layer documents](/docs/build/ossie-semantic-models).
