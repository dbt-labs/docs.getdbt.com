...
Supply and nest these additional configurations, unique to BigQuery, under `config.biqquery` (in the new catalog spec) or `adapter_properties` (in the old catalog spec).
