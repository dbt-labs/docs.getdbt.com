...
_Available in <Constant name="core" /> v1.12+ (including <Constant name="core_v2" /> and <Constant name="fusion" />). See GitHub discussion [dbt-labs/dbt#12723](https://github.com/dbt-labs/dbt/discussions/12723) for an explanation of the motivations behind the new spec, and an overview of what's changed._
