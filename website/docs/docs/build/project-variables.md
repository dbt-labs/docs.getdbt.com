...
1. In the `vars.yml` file (recommended for projects with several variables or for projects with variables you need to reference from within `dbt_project.yml`)
