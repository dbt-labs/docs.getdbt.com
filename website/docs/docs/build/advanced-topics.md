...
The <Constant name="dbt" /> <Constant name="semantic_layer" /> and MetricFlow are powerful tools that allow you to define metrics and semantic models in your <Constant name="dbt" /> project. 

This section covers advanced topics for the <Constant name="dbt" /> <Constant name="semantic_layer" /> and MetricFlow, such as data modeling workflows, and more.
<!--
