...
:::info Availability
The new YAML spec is currently available in the <Constant name="fusion_engine" /> and in the <Constant name="dbt_platform" /> **Latest** release track. It will be coming soon to <Constant name="core" /> v1.12. 
