...
After a compatible version is released, update your project to install the new package version. You can then migrate your metrics to the latest spec with the the following steps, depending on which tool you're using.
