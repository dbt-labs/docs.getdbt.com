...
- **Lack of print() support.** Because your Python model is compiled and run entirely inside the data platform without oversight from dbt, the output of commands like `print()` is not shown in dbt's logs. 
