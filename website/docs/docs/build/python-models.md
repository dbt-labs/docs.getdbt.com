...
Python models for Snowflake, BigQuery, and Databricks are supported in [<Constant name="fusion" />](/docs/dbt/about-fusion). Please refer to the [supported features](/docs/dbt/supported-features) page to learn more about <Constant name="fusion" />.
