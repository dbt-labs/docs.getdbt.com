...
| [require-dbt-version](/reference/project-configs/require-dbt-version) | Restrict your project to only work with a range of [<Constant name="core" /> versions](/docs/dbt-versions/dbt-versions) |
