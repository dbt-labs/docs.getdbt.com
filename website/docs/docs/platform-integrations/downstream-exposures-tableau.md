...
This beta capability requires deployment jobs on [**v1 Latest**](/docs/dbt-versions/dbt-release-tracks) with <Constant name="core" /> and _isn't_ available on [**v2 Stable**](/docs/dbt-versions/dbt-release-tracks) (the <Constant name="fusion_engine" /> preview). For setup details, refer to [Orchestrate exposures](/docs/platform-integrations/orchestrate-exposures).
