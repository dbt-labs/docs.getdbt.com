...
- Verified your environment and jobs use [Latest](/docs/dbt-versions/cloud-release-tracks) with <Constant name="core" />. [Latest&nbsp;<Constant name="fusion" />](/docs/dbt-versions/cloud-release-tracks), the <Constant name="fusion_engine" /> preview, does <em>not</em> support orchestrating downstream exposures yet.
