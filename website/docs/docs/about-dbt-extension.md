...
Your dbt environment must be using the <Constant name="fusion_engine" /> in order to use this extension. See [the Fusion documentation](/docs/dbt/about-fusion) for more on eligibility and upgrading.
