...
| ----------------------------------------------- |----------------------------------| ---------------------------------|
| [Athena](athena-setup)                | [Hive](hive-setup)               | [Rockset](rockset-setup)  |
| [Clickhouse](clickhouse-setup)        | [Impala](impala-setup)           | [SingleStore](singlestore-setup)  |
| [IBM DB2](ibmdb2-setup)               | [Infer](infer-setup)             | [SQLite](sqlite-setup) |
...
| [Greenplum](greenplum-setup)          | [Oracle](oracle-setup)           
