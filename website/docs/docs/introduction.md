...
- [Install the Fusion CLI](/docs/local/install-dbt?version=2) &mdash; The <Constant name="fusion_engine" /> from the command line, but doesn't include <Term id="lsp" /> features.
