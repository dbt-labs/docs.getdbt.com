...
1. Follow [these instructions](/docs/get-started/installation) to install the dbt CLI
2. [Set up a profile](/docs/get-started/connection-profiles) to connect to your data warehouse
