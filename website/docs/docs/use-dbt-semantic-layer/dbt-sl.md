...
The dbt Semantic Layer is available to all dbt Cloud plans (Developer, Team, and Enterprise) during [public beta](/docs/dbt-versions/release-notes/06-July-2023/sl-revamp-beta). Start exploring the dbt Semantic Layer by visiting the following pages:
