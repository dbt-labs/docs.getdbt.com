...
- [<Constant name="semantic_layer" /> APIs](/docs/dbt-platform-apis/sl-api-overview) &mdash; Use the <Constant name="semantic_layer" /> APIs to query metrics in downstream tools for consistent, reliable data metrics.
