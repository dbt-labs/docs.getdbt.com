...
The dbt Semantic Layer is currently available in Public Preview for multi-tenant dbt Cloud accounts hosted in North America (logging in via https://cloud.getdbt.com/)
