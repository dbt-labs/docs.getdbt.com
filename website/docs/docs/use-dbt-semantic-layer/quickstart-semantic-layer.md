...
- [dbt Server repo](https://github.com/dbt-labs/dbt-server), which wraps dbt Core in a persistent server that is responsible for handling RESTful API requests for dbt operations
