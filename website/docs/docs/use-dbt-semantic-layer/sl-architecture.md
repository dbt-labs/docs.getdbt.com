...
At a high level, the dbt Semantic Layer has two primary components -- defining your metrics in MetricFlow and querying them with Semantic Layer APIs. These are made possible by the following architechtural pieces:
