...
---
import expandTable from '/src/components/ExpandTable';
...
<!--
import markdownContent from '/snippets/_abctest.md';

<expandTable markdown= {markdownContent}/>
-->

<expandTable markdown={ `
