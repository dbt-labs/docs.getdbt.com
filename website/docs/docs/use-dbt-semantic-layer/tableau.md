...
1. Download the GitHub [connector file](https://github.com/dbt-labs/semantic-layer-tableau-connector/releases/download/v1.1.0/dbt_semantic_layer.taco) locally and add it to your default folder:
