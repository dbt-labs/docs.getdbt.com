...
- You must have a dbt Cloud Team or Enterprise [account](https://www.getdbt.com/pricing) and multi-tenant [deployment](/docs/cloud/about-cloud/access-regions-ip-addresses). (Single-Tenant coming soon)
