...
This means that you are using dbt's default implementation of the macro, as defined [here](https://github.com/dbt-labs/dbt/blob/HEAD/core/dbt/include/global_project/macros/etc/get_custom_schema.sql#L17-L30)
