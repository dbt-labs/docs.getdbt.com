...
- Data tests are written as <Term id="cte">CTEs</Term> instead of subqueries. Adapter plugins for databases that don't support CTEs may need to override this behavior.
