---
title: "Upgrading to v1.0 (latest)"
...
- Add `result:<status>` subselectors for smarter reruns when dbt <Term id="model">models</Term> have errors and tests fail. See examples: [Pro-tips for Workflows](/docs/guides/best-practices.md#pro-tips-for-workflows)
