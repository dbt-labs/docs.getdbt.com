...
), please let the community know that is available to use by adding the adapter to the [Supported Data Platforms](supported-data-platforms) page by following the steps given in [Documenting your adapter](docs/contributing/documenting-a-new-adapter).
...
- Adding to the list of ["Available Adapters"](supported-data-platforms#community-supported)
