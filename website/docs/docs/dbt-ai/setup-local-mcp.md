...
Only accounts with static subdomains (for example, `abc123.us1.dbt.com`) can use OAuth with MCP servers. To find your account subdomain, navigate to Account Settings > Account > Access URL. If your account does not have a subdomain, contact support for more information.
