...
Remote MCP doesn't depend on this setting. `text_to_sql` is the only tool that needs AI features &mdash; with them off, it's hidden and the rest of the tools work as usual.
