...
- `get_lineage`: Retrieves upstream/downstream dependencies for dbt resources (max 50 nodes per direction). Currently only supports name-based search for models and sources.
