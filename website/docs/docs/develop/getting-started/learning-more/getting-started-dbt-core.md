...
When you use dbt Core to work with dbt, you will be editing files locally using a code editor, and running projects using the dbt command line interface (dbt CLI). If you'd rather edit files and run projects using the web-based Integrated Development Environment (IDE), you should refer to [Getting set up in dbt Cloud](/docs/develop/getting-started/getting-set-up).
...
* Complete [Setting up (in BigQuery)](/docs/develop/getting-started/getting-set-up/setting-up-bigquery#setting-up) and [Loading data (BigQuery)](/docs/develop/getting-started/getting-set-up/setting-up-bigquery#loading-data).
