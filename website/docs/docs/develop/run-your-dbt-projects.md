...
Among other features, dbt Cloud provides an integrated development environment (IDE) to help you build, test, run, and version control your project faster. It also includes a purpose-built scheduler and an easier way to share your [dbt project's documentation](/docs/collaborate/build-and-view-your-docs) with your team. These development tasks are directly built into dbt Cloud. Review [dbt Cloud IDE] (/docs/develop/develop-in-the-cloud) for more details.
