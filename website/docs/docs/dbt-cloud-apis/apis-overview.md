...
- The [<Constant name="cloud" /> Discovery API](/docs/dbt-cloud-apis/discovery-api) can be used to fetch metadata related to the state and health of your <Constant name="dbt" /> project.
- The [<Constant name="dbt" /> <Constant name="semantic_layer" /> APIs](/docs/dbt-cloud-apis/sl-api-overview) provides multiple API options which allow you to query your metrics defined in the <Constant name="dbt" /> <Constant name="semantic_layer" />.
