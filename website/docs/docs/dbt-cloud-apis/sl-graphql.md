...
| North America Cell 1	|	`https://semantic-layer.YOUR_ACCOUNT_PREFIX.us1.dbt.com/api/graphql`<br /><br />  Replace `YOUR_ACCOUNT_PREFIX` with your specific account prefix and make sure you leave `us1.dbt.com` in the URL. |<br />
