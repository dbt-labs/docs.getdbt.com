...
1. You can use it for [ad-hoc GraphQL queries](/docs/dbt-cloud-apis/metadata-api-quickstart) to explore your dbt project and diagnose its performance
