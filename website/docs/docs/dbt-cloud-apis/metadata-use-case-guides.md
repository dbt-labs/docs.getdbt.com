...
2. Share metadata generated by your dbt project and its execution with other tools in your stack, allowing users in your organization to do the following things and more:
