...
1. [Ad-hoc GraphQL queries](/docs/dbt-cloud-apis/metadata-querying) to explore your dbt project and diagnose its performance. Refer to the example use cases and queries on this page. 
