...
The [Example queries](#example-queries) illustrate a few fields you can query in this `environment` object. Refer to [Fields](#fields) to view the entire schema, which provides all possible fields you can query.
