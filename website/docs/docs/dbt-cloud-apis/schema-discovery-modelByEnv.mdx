...
The model by environment object is being deprecated and will be replaced with `environment { applied { modelHistoricalRuns } }`. You will need to update your API calls accordingly to avoid errors. Refer to the 
