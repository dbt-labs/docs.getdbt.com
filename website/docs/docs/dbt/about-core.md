...
Over time, new capabilities will land in v2 only, so most people will eventually want to upgrade. When you're ready, we recommend checking out the [Upgrade to v2](/docs/dbt-versions/dbt-upgrade/upgrading-to-v2) guide.
