...
<Card
    title="Install dbt"
    body="Install dbt to get Fusion from your command line."
...
<Card
    ...
    body="Get Fusion's performance plus autocomplete, inline errors, and lineage in your editor."
...
<Card
    ...
    body="Create a dbt platform account to unlock the full Fusion feature set."
