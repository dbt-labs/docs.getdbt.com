...
For most people: <Constant name="fusion" />. It has more [capabilities](/docs/fusion/fusion-availability?version=2.0#what-you-get-with-fusion) out of the box than <Constant name="core_v2" /> &mdash; including a built-in high-performance SQL linter &mdash; even if you never create a dbt account.
