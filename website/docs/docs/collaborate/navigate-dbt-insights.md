...
tags: [dbt Insights]
image: /img/docs/dbt-insights/qp-results.jpg
---

# Navigate the dbt Insights interface <Lifecycle status="beta,enterprise" />

<IntroText>
Learn how to navigate the dbt Insights interface and use the main components.
</IntroText>
...
dbt Insights provides an interactive interface for writing, running, and analyzing SQL queries. This section highlights the main components of the dbt Insights interface. 

## Query console
The query console is the main component of the dbt Insights interface. It allows you to write, run, and analyze SQL queries. The Query console supports:
...
<Lightbox src="/img/docs/dbt-insights/qp-main.png" title="dbt Insights main interface with blank query editor" />
...
<Lightbox src="/img/docs/dbt-insights/qp-ellipsis.jpg" title="dbt Insights ellipsis button" />
-->
...
<Lightbox src="/img/docs/dbt-insights/qp-results.jpg" width="95%" title="dbt Insights Results tab" />
...
<DocCarousel slidesPerView={1}>
<Lightbox src="/img/docs/dbt-insights/qp-explorer.png" width="90%" title="dbt Insights dbt Explorer icon" />
<Lightbox src="/img/docs/dbt-insights/qp-ellipsis.gif" width="90%" title="dbt Insights bookmark icon" />
<Lightbox src="/img/docs/dbt-insights/qp-query-history.png" width="90%" title="dbt Insights Query history icon" />
<Lightbox src="/img/docs/dbt-insights/qp-copilot.gif" width="90%" title="dbt Insights dbt Copilot" />
</DocCarousel>
