...
<Constant name="query_page" /> provides an interactive interface for writing, running, and analyzing SQL queries. This section highlights the main components of the <Constant name="query_page" /> interface. 

## Query console
The query console is the main component of the <Constant name="query_page" /> interface. It allows you to write, run, and analyze SQL queries. The Query console supports:
