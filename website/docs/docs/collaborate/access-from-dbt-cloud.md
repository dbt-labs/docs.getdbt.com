...
Access dbt Explorer directly from [dbt Insights](/docs/collaborate/access-dbt-insights) to view the project lineage and project resources with access to tables, columns, metrics, dimensions, and more.

To access dbt Explorer from dbt Insights, click on the **Explorer** icon in the console sidebar menu and search for the resource you're interested in.
