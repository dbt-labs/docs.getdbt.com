...
Access dbt Explorer directly from [<Constant name="query_page" />](/docs/collaborate/access-dbt-insights) to view the project lineage and project resources with access to tables, columns, metrics, dimensions, and more.

To access dbt Explorer from <Constant name="query_page" />, click on the **Explorer** icon in the console sidebar menu and search for the resource you're interested in.
