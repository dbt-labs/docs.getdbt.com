...
* If you're new to dbt, we recommend that you check out our [Getting Started Tutorial](/docs/develop/getting-started/getting-set-up) to build your first dbt project, complete with documentation.
