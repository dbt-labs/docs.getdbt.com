...
* If you're new to dbt, we recommend that you check out our [Getting Started Tutorial](/docs/get-started/getting-started/set-up-dbt-cloud) to build your first dbt project, complete with documentation.
