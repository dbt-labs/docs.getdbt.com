...
- [Query console menu](#query-console-menu), which contains **Bookmark** and **Run** buttons. 
  - ✨ Coming soon: Ability to open the [<Constant name="cloud" /> <Constant name="cloud_ide" />](/docs/cloud/dbt-cloud-ide/develop-in-the-cloud) or [<Constant name="visual_editor" />](/docs/cloud/visual-editor) to continue editing your SQL query.
...
- [Query console sidebar menu](#query-console-sidebar-menu), which contains the **<Constant name="dbt" /> <Constant name="explorer" />**, **Bookmark**, **Query history**, and **<Constant name="dbt" /> <Constant name="copilot" />** icons.
...
- **Bookmark** button &mdash; Save your frequently used SQL queries as favorites for easier access.
  ...
  - Let [<Constant name="dbt" /> <Constant name="copilot" />](/docs/cloud/dbt-copilot) do the writing for you &mdash; use the AI assistant to automatically generate a helpful description for your bookmark.
...
- ✨ Coming soon &mdash; Ability to access the [<Constant name="cloud" /> <Constant name="cloud_ide" />](/docs/cloud/dbt-cloud-ide/develop-in-the-cloud) or [<Constant name="visual_editor" />](/docs/cloud/visual-editor) from the Query console menu to develop your query and promote it to a reusable model.
...
- **Details** tab &mdash; Generates succinct details of executed SQL query:
  - Query metadata &mdash; <Constant name="dbt" /> <Constant name="copilot" />'s AI-generated title and description. Along with the supplied SQL and compiled SQL.
...
- **<Constant name="dbt" /> <Constant name="explorer" /> icon** &mdash; View your project’s tables, columns, metrics, lineage, and more using the integrated <Constant name="explorer" /> view.
- **Bookmark icon** &mdash; Save and access your frequently used queries. 
  ...
  - Enhance bookmarked queries with <Constant name="dbt" /> <Constant name="copilot" />'s AI-generated descriptions.
...
- **<Constant name="dbt" /> <Constant name="copilot" /> icon** &mdash; Use [<Constant name="dbt" /> <Constant name="copilot" />'s AI assistant](/docs/cloud/dbt-copilot) to modify or generate queries using natural language prompts.
