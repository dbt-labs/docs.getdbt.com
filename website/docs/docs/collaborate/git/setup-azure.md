...
4. Complete the form:
    - **Azure DevOps Organization:** Must match the name of your Azure DevOps organization exactly. Do not include the `dev.azure.com/` prefix in this field: <br />
    ✅ Use `my-devops-org` <br />
    ❌ Avoid `dev.azure.com/my-devops-org`
