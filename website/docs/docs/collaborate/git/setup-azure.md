...
4. Complete the form:
    - **Azure DevOps Organization:** Must match the name of your Azure DevOps organization exactly. Do not include `dev.azure.com/` in this field - i.e. use `my-devops-org` instead of `dev.azure.com/my-devops-org`.
