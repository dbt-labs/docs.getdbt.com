...
- Use a recent version of dbt (v1.6, v1.7, or [Release Tracks](/docs/dbt-versions/cloud-release-tracks)") for both the upstream ("producer") project and the downstream ("consumer") project.
