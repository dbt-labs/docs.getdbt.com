...
- Define models in an upstream ("producer") project that are configured with [`access: public`](/reference/resource-configs/access). Once defined, re-run a production job to apply the change.
