...
- **Model query history** &mdash; Use [model query history](/docs/collaborate/model-consumption) to track the history of queries on your models for deeper insights.
