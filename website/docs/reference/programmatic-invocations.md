...
For implementation details, refer to the source definitions of `dbtRunner` and `dbtRunnerResult` in the [<Constant name="core" /> repository](https://github.com/dbt-labs/dbt-oss/blob/1.latest/core/dbt/cli/main.py).
...
For implementation details, refer to the [`dbt-python` crate](https://github.com/dbt-labs/dbt-oss/tree/main/crates/dbt-python) in the <Constant name="core" /> repository.
