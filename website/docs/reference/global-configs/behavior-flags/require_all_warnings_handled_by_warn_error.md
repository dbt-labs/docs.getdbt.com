...
| require_all_warnings_handled_by_warn_error | <Constant name="dbt" /> **v1 Latest** | <Constant name="core" /> |
|---|---|---|
...
Starting in <Constant name="dbt" /> v1.12, the `require_all_warnings_handled_by_warn_error` flag defaults to `true`.
