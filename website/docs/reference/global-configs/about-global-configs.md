...
You can use flags in <Constant name="core"/> or the <Constant name="fusion_engine"/> through the CLI during local development or in <Constant name="dbt_platform"/>.
...
| Flag | Type / default | In project? | Environment variable | <div style={{width:'200px'}}>CLI flags</div> | dbt platform CLI? |
|------|----------------|-------------|---------|-----------|----------------|
...
| [profile](/docs/local/profiles.yml#about-profiles) | string / None | ✅ (as top-level key) | `DBT_PROFILE`  | [`--profile`](/docs/local/profiles.yml#overriding-profiles-and-targets) | ❌ |
| [profiles_dir](/docs/local/profiles.yml#about-profiles) | path / None (current dir, then HOME dir) | ❌ | `DBT_PROFILES_DIR` | `--profiles-dir` | ❌ |
| [project_dir](/reference/dbt_project.yml) | path / (empty) | ❌ | `DBT_PROJECT_DIR` | `--project-dir` | ❌ |
...
| [target](/docs/local/profiles.yml#about-profiles) | string / None | ❌ | `DBT_TARGET` | [`--target`](/docs/local/profiles.yml#overriding-profiles-and-targets) | ❌ |
...
| [project_dir](/reference/dbt_project.yml) | path / (empty) | ❌ | `DBT_ENGINE_PROJECT_DIR` | `--project-dir` | ❌ |
