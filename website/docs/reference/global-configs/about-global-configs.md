...
| [indirect_selection](/reference/node-selection/test-selection-examples#test-selection-syntax-examples) | ❌ | enum <br /> default: eager | ✅ | `DBT_INDIRECT_SELECTION` | `--indirect-selection` |
| [introspect](/faqs/Warehouse/db-connection-dbt-compile#introspective-queries) | ❌ | boolean <br /> default: True | ❌ | `DBT_INTROSPECT` | `--introspect` <br /> `--no-introspect` |
...
| [profile](/docs/local/profiles.yml#about-profilesyml) | ❌ | string <br /> default: None | ✅ (as top-level key) | `DBT_PROFILE`  | [`--profile`](/docs/local/profiles.yml#overriding-profiles-and-targets) |
| [profiles_dir](/docs/local/profiles.yml#about-profilesyml) | ❌ | path <br /> default: None (current dir, then HOME dir) | ❌ | `DBT_PROFILES_DIR` | `--profiles-dir` |
...
| [target](/docs/local/profiles.yml#about-profilesyml) | ❌ | string <br /> default: None | ❌ | `DBT_TARGET` | [`--target`](/docs/local/profiles.yml#overriding-profiles-and-targets) |
...
| [use_experimental_parser](/reference/global-configs/parsing#static-parser) | ❌ | boolean <br /> default: False | ✅ | `DBT_USE_EXPERIMENTAL_PARSER` | `--use-experimental-parser` <br /> `--no-use-experimental-parser` |
...
| [indirect_selection](/reference/node-selection/test-selection-examples#test-selection-syntax-examples) | ❌ | enum <br /> default: eager | ✅ | `DBT_ENGINE_INDIRECT_SELECTION` | `--indirect-selection` |
| [introspect](/faqs/Warehouse/db-connection-dbt-compile#introspective-queries) | ❌ | boolean <br /> default: True | ❌ | `DBT_ENGINE_INTROSPECT` | `--introspect` <br /> `--no-introspect` |
...
| [use_experimental_parser](/reference/global-configs/parsing#static-parser) | ❌ | boolean <br /> default: False | ✅ | `DBT_ENGINE_USE_EXPERIMENTAL_PARSER` | `--use-experimental-parser` <br /> `--no-use-experimental-parser` |
