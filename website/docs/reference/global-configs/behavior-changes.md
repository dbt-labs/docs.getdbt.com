...
For flags that have already reached maturity, refer to [Mature behavior flags](/reference/global-configs/behavior-flag-maturity). For flags still in the introduction phase, refer to [Introduced behavior flags](/reference/global-configs/behavior-flag-introduction). For flags removed in <Constant name="core_v2" />, refer to [Removed behavior flags](/reference/global-configs/behavior-flag-removed).
