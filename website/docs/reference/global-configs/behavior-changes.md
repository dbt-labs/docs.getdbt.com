...
- [Deprecated CLI flags](/docs/dbt-versions/dbt-upgrade/upgrading-to-v2#deprecated-flags) &mdash; Command-line flags being removed in dbt v2

See the [Changes overview](/reference/changes-overview) for a quick comparison.

If you're upgrading to [dbt v2](/docs/dbt-versions/dbt-upgrade/upgrading-to-v2), a subset of behavior change flags are removed and their new behavior is always enabled.
