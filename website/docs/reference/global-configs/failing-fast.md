...
For the full precedence rules and environment-variable equivalent (`DBT_FAIL_FAST`), see the [`fail_fast` row in About global configs](/reference/global-configs/about-global-configs#available-flags).
