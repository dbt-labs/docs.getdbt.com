...
While you shouldn't notice any behavior changes due to this change, however, to be cautious <Constant name="dbt" /> Labs is gating it behind a behavior-change flag and encouraging you to test it before it becoming the default.
