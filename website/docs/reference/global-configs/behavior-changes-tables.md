...
id: "behavior-changes-tables"
sidebar_label: "Behavior change flags"
---

For conceptual background on behavior change flags, refer to [Behavior changes](/reference/global-configs/behavior-changes). For detailed documentation on each individual flag, refer to the [individual behavior flags reference](/category/individual-behavior-flags).
