...
Configurations can be applied to snapshots using the [YAML syntax](/docs/build/snapshots), available in [the dbt Cloud "Latest" release track](/docs/dbt-versions/cloud-release-tracks) and dbt v1.9 and higher, in the `snapshot` directory file.
...
Configurations can be applied to snapshots using [YAML syntax](/docs/build/snapshots), available in [the dbt Cloud "Latest" release track](/docs/dbt-versions/cloud-release-tracks) and dbt v1.9 and higher, in the `snapshot` directory file.
...
1. Defined in YAML files using a `config` [resource property](/reference/model-properties), typically in your [snapshots directory](/reference/project-configs/snapshot-paths) (available in [the dbt Cloud "Latest" release track](/docs/dbt-versions/cloud-release-tracks) and dbt v1.9 and higher).
