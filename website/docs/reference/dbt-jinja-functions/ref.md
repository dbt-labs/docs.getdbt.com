...
Another example is when a reference appears within an [`is_incremental`](/docs/build/incremental-models#understand-the-is_incremental-macro) conditional block.
