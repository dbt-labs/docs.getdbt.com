...
The list of available flags is defined in the [`flags` module](https://github.com/dbt-labs/dbt/blob/HEAD/crates/dbt-jinja-utils/src/flags.rs) within `dbt-core`.
