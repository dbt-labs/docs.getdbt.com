...
- **<Constant name="core" />:** These values are based on the target defined in your [profiles.yml](/docs/local/connect-data-platform/profiles.yml) file. Please note that for certain adapters, additional configuration steps may be required. Refer to the [set up page](/docs/local/connect-data-platform/about-core-connections) for your data platform.
- **<Constant name="cloud" />** To learn more about setting up your adapter in <Constant name="cloud" />, refer to [About data platform connections](/docs/cloud/connect-data-platform/about-connections).
