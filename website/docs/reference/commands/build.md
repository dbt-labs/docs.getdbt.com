...
- build [user-defined functions](/docs/build/udfs) (available from <Constant name="dbt" /> v1.11 and in <Constant name="fusion_engine" />)
...
## Functions
_Available from <Constant name="dbt" /> v1.11 and in <Constant name="fusion_engine" />_
