...
- `--no-introspect` to disable [introspective queries](https://docs.getdbt.com/faqs/warehouse/db-connection-dbt-compile#introspective-queries). dbt will raise an error if a model's definition requires running one.
