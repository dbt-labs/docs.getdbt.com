...
Use the `dbt docs serve` command if you're developing locally with the [<Constant name="cloud_cli" />](/docs/cloud/cloud-cli-installation) or [<Constant name="core" />](/docs/install-dbt). The [<Constant name="cloud_ide" />](/docs/cloud/studio-ide/develop-in-studio) doesn't support this command.
...
:::info Note
The `--host` flag is only available in the [<Constant name="core"/>](/docs/install-dbt). It's not supported in the [<Constant name="cloud_cli" />](/docs/cloud/cloud-cli-installation).
:::
