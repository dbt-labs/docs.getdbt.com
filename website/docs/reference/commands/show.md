...
#### `--info` flag
- The `--info <view>` flag queries the [dbt Information Schema](/docs/build/dbt-information-schema) directly from the CLI. It reads from `target/info_schema/` and does not connect to your warehouse.
