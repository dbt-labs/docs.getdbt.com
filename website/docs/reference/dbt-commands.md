...
:::info
Some commands are not yet supported in the <Constant name="fusion_engine" /> or have limited functionality. Refer to the [<Constant name="fusion" /> supported features](/docs/fusion/supported-features) page for details.
:::
...
| [freshness](/reference/commands/freshness) <Lifecycle status="beta" /> | Checks freshness for all sources and models with freshness configured | ✅ | <Constant name="core_v2" /> only |
