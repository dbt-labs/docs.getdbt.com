...
- [manifest](manifest-json): produced by `build`, `compile`, `run`, `test`, `docs generate`, `ls`, `build`, `run-operation`
- [run results](run-results-json): produced by `build`, `run`, `test`, `seed`, `snapshot`, `docs generate`, `build`
