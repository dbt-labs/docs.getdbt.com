...
This file contains information about [sources with freshness checks](/docs/build/sources#checking-source-freshness). Today, <Constant name="cloud" /> uses this file to power its [Source Freshness visualization](/docs/build/sources#source-data-freshness).
