...
If the converter encounters an unsupported configuration, dbt logs a `SemanticValidationFailure` warning and skips writing `osi_document.json` for that invocation.
