...
This file is the skeleton of the [auto-generated <Constant name="dbt" /> documentation website](/docs/collaborate/build-and-view-your-docs). The contents of the site are populated by the [manifest](/reference/artifacts/manifest-json) and [catalog](catalog-json).
...
This file is used to store a compressed representation of files <Constant name="dbt" /> has parsed. If you have [partial parsing](/reference/parsing#partial-parsing) enabled, <Constant name="dbt" /> will use this file to identify the files that have changed and avoid re-parsing the rest.

### graph.gpickle

**Produced by:** commands supporting [node selection](/reference/node-selection/syntax)

Stores the network representation of the <Constant name="dbt" /> resource DAG.
