...
| `database`               | Yes | The name of your database. If you are using custom database names in your <Term id="model">models</Term> config, they must be created prior to running those models. |
