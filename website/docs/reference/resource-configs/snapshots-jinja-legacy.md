...
- YAML-based syntax:
  - Defined in `whatever_name.yml` or in the `snapshots` or `models` directory you prefer. Available in <Constant name="dbt" />'s **v1 Latest** release track and dbt v1.9 and later.
