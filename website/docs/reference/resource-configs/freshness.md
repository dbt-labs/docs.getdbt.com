...
:::note Fusion only
Freshness model configurations are only available for the <Constant name="fusion_engine" />. Refer to [Source data freshness](/docs/build/sources#source-data-freshness) when using dbt Core.
:::
