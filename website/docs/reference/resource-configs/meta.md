...
You can't add YAML `meta` configs for [generic tests](/docs/build/data-tests#generic-tests). However, you can add `meta` properties to [singular tests](/docs/build/data-tests#singular-tests) using `config()` at the top of the test file. 
