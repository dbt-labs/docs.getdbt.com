---
title: volatility
description: "Declare the volatility (deterministic, stable, or non-deterministic) of a Python user-defined function (UDF) so the warehouse can optimize how it runs."
