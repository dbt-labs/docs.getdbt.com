...
- Databricks: Accepted for compatibility but has no effect. Databricks manages the Python runtime internally, so dbt displays a warning if you set it. (Available in dbt-databricks 1.12+)
