...
## Description
The snapshot strategy <Constant name="dbt" /> should use to detect record changes. Read the guide to [snapshots](/docs/build/snapshots#detecting-row-changes) to understand the differences between the two.
