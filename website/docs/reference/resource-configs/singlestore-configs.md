...
The [`incremental_strategy` config](/docs/build/incremental-models#configure-incremental-materializations) controls how dbt builds incremental models. Currently, SingleStoreDB supports `delete+insert`, `append`, and `microbatch` configurations.
