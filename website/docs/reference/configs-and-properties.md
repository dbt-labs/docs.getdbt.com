...
* Assert "truths" about a model, in the form of [tests](/docs/build/data-tests), e.g. "this `id` column is unique"
...
Note - Generic tests work a little differently when it comes to specificity. See [test configs](/reference/data-test-configs).
