...
The following profile fields are all required except for `user`, which is required unless you're using the `oauth`, `cert`, or `jwt` authentication methods.
...
| `impersonation_user` (optional) | `impersonated_tom`                                                                                                                                    | Override the provided username. This is used for impersonation.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
<br/>
