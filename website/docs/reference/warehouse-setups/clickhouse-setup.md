...
| `use_lw_deletes`       | Optional. If ClickHouse experimental lightweight deletes are enabled, use the `delete+insert` strategy as the default strategy for incremental materializations.  Defaults to `False` (use legacy strategy).                                                                                                                                                                                                                                                                 |
