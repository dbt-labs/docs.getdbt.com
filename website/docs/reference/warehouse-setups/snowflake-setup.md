...
| reuse_connections | No | A boolean flag indicating whether to close connections after node execution or to reduce total connections opened by reusing idle ones. Default: False |
